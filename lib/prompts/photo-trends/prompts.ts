...
export const prompts: readonly Prompt[] = [
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same bone structure, jawline, nose, eyes, lips, skin tone and age, no slimming, no smoothing, no lightening, and the same real hairline — with zero drift or restyling as the clip plays. The only motion is a single slow, natural blink and the faintest settling of my shoulders, nothing else in frame moves: my hair, the blazer collar and the backdrop stay completely still. Camera: a locked-off tripod shot, no push, no pan, no reframing. The single hard key high to the left must hold at exactly the same angle and intensity for the whole clip, so the hard-edged shadow it throws behind my right shoulder stays fixed in position and never softens, drifts or grows a second edge. Keep the fine 35mm grain and the soft halation on my cheekbone exactly as strong for the full runtime — the image must not sharpen, stabilise or clean itself up as it plays. Add only the faint electrical hum of a studio light ballast, otherwise near-silence — no dialogue, no music, no narration. Exclude any modern object entering frame, any on-screen text, any watermark, and any change to the backdrop's mottled pattern. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, with a first and last frame close enough to loop without a visible seam.`,
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same bone structure, nose, eyes, lips, skin tone and age, no slimming or smoothing — with zero drift as the clip plays. The only motion is a light breeze moving my hair and shirt collar and a thin curl of roadside dust drifting past at ground level; the Ambassador itself, my pose and the background building stay completely still, with no wheels turning and no sense of the car moving. Camera: a very slow, barely-there push on a slider, nothing fast enough to blur the car's upright body panels or its chrome trim. The low late-afternoon sun must keep the same angle and hardness for the whole clip, so the hard shadows it throws across the road and the hot specular streak along the chrome neither move nor soften. Keep the warm faded 1986 film colour, the grain and the cyan-shifted shadows exactly as strong for the full runtime. Add only distant road traffic and a single bird call, low in the mix — no dialogue, no music. Exclude any modern vehicle entering the background, any phone, and any on-screen text. Output: 6 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, ending close enough to its own first frame to loop cleanly.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone and age, no slimming, smoothing or beautifying — with zero drift as the clip plays. The only motion is a slow natural blink and breath, plus the television screen behind me flickering faintly with a shifting scan-line shimmer; the room, my pose and every object on the shelves stay completely still. Camera: a locked-off tripod shot, no push, no pan. The direct on-camera flash exposure must hold exactly as it does in the still — my face stays flat and evenly over-lit, and the hard compact shadow it throws on the wall directly behind my head must not move, soften, or change size as the screen's light flickers. Keep the coarse grain and the warm tungsten cast exactly as strong for the full runtime, with the room's edges staying just as dark. Add only quiet room tone and the television's faint electrical hum, with no legible programme audio — no dialogue, no music. Exclude any flat-screen, remote or modern branding entering frame, and any on-screen text. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, with a loop-safe start and end frame.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone and age — and keep coloured stage light confined to my hair and shoulders exactly as in the still, never washing across my face or reshaping a feature. The only motion is the turn the pose already implies completing itself: my weight finishes shifting fully onto the other leg and my hair swings once with it, while the haze drifts slowly and steadily through the laser beams behind me — nothing else changes pace or direction. Camera: a slow, small arc around me at a fixed distance, not a push, not a handheld shake, the kind of restrained move a motorised slider produces. The one hard warm key and the coloured rim from behind must hold their exact angle and colour for the whole clip, so the hot edge on my hair and shoulder neither drifts nor changes hue. Keep the coarse pushed-film grain and the halation blooming off the sequins exactly as strong throughout. Add a muffled, distant disco bassline and a faint crowd murmur, both low enough to sit under the image — no legible lyrics, no dialogue. Exclude any modern stage screen or phone light entering frame. Output: 6 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still as a magazine-cover 'comes alive' teaser, not as a scene with a new background. Keep my face exactly as it is for every frame — same features, skin tone and age, no slimming or smoothing, and no drift toward a generic cover-model face. The only motion is a slow, natural blink and a faint catch of light moving across my hair as my head tilts a fraction of a degree; the masthead, the cover lines and the barcode stay perfectly still and exactly as legible or illegible as they are in the still, never re-flowing or sharpening into real words. Camera: a locked-off tripod shot, no push, no pan. The soft key above the lens and the hard hair light behind must hold their exact position and intensity for the whole clip. Keep the oversaturated print ink, the faint halftone dot pattern and the slightly imperfect colour registration exactly as strong throughout — the cover must read as printed paper the whole time, never as a clean digital render. No sound, or at most a very quiet studio-room hush — no music, no dialogue, nothing implying a cover story being read aloud. Exclude any Devanagari text, any real magazine's name, and any new lettering appearing. Output: 4 seconds, one unbroken shot, no cuts, vertical 3:4 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone and age, no slimming, smoothing or making me look younger — with zero drift as the clip plays. The only motion is my half-smile widening slightly, as if a friend just called my name again, while the wind lifts my denim jacket collar and hair by the same small amount already implied in the still; the pillar, the notice board and the sunlit greenery beyond stay completely still. Camera: a locked-off tripod shot, or at most the faintest handheld sway, as if a friend is holding the phone rather than a stabilised rig. The open-shade lighting on my face must hold exactly as soft and cool as the still, and the sunlit background beyond the corridor must stay blown out several stops brighter without ever resolving into visible detail. Keep the flat contrast, the faded warm 1985 colour and the grain exactly as strong throughout. Add distant campus chatter and birdsong, low in the mix — no dialogue directed at camera, no music. Exclude any modern object, phone or on-screen text entering frame. Output: 6 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone and age, no slimming or smoothing — and keep the sehra strings exactly where they sit in the still, clearly above my eyebrows, never drifting lower as the horse moves. The only motion is the horse shifting its weight once and flicking its tail, which sways the hanging sehra strings and garlands by the same small amount; the tube-light behind flickers faintly, and nothing else in frame moves. Camera: a locked-off tripod shot — a moving camera on horseback framing risks losing the very face this whole prompt protects. The hard direct night flash must hold its exact intensity and angle for the whole clip, so the flat over-exposed lighting on my face, the steep falloff into the dim crowd behind, and the weak greenish tube-light rake all stay fixed. Keep the coarse night-film grain and the warm-magenta cast exactly as strong throughout. Add a distant dhol beat and a murmuring wedding crowd, low and non-intrusive — no dialogue, no clear lyrics. Exclude any modern lighting rig or phone light entering frame. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone and age, no slimming or smoothing, and no ageing me up or down — with zero drift as the clip plays. The only motion is the ceiling fan blade visible at the top of frame turning slowly, which lifts the topmost sheet in the red-taped file stack by a faint amount as I blink once, naturally; the almirah, the desk objects and the wall calendar stay completely still. Camera: a locked-off tripod shot, no push, no pan. The overhead fluorescent tube light must hold its exact angle and the same uncorrected green-cyan cast for the whole clip, so my eye sockets stay just as shadowed as in the still and no colour-correction creeps in as it plays. Keep the flat muted contrast and the film grain exactly as strong throughout. Add a low ceiling-fan whir and distant, indistinct office chatter, low in the mix — no dialogue, no music. Exclude any computer, monitor or modern phone entering frame. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same bone structure, jawline, nose, eyes, lips, skin tone, age and natural asymmetry, no slimming or lightening — with zero drift as the clip plays. The only motion is the wind already lifting the pallu in the still continuing for a moment longer, rippling the same thin chiffon folds and moving the loose strands of hair around my face, while the grass on the slope behind ripples faintly in the same gusts; nothing else changes direction or speed. Camera: a slow, gentle push on a slider, matching the wind's own pace rather than fighting it. The low backlight must hold its exact angle for the whole clip, so the hot rim it traces on my hair, shoulder and the lifted pallu neither dims nor shifts, and the bounce-fill lighting my face from the ground must stay exactly as bright so I never drift toward silhouette. Keep the warm 1987 film grain, the halation on my backlit hair and the veiling flare in the corner exactly as strong throughout. Add only wind and distant birdsong — no dialogue, no music. Exclude any modern object entering the hillside. Output: 6 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone and age, no slimming, lightening or smoothing — with zero drift as the clip plays. The only motion is my dupatta and loose hair moving gently in the terrace breeze, dust catching the low warm light exactly as it does in the still, and a single bird crossing the hazy skyline far in the background; the water tanks, aerials and washing lines stay completely still. Camera: a slow, small pan across the parapet line, not a push toward me. The very low, near-horizontal sun must hold its exact angle for the whole clip, so the warm-orange light on the left of my face and the cool blue-grey ambient on the shadow side stay in the same balance, and the long shadows across the terrace neither shorten nor rotate. Keep the warm cast, the cyan-shifted shadows and the film grain exactly as strong throughout. Add distant city ambience and birdsong, low in the mix — no dialogue, no music. Exclude any satellite dish, solar panel or modern glass building entering frame. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same bone structure, jawline, nose, eyes, brow, lips, skin tone, age and natural asymmetry, no reshaping — with zero drift toward a smoother or more symmetrical face. The only motion is a single slow, natural blink and my head settling a fraction further into the pose, catching the hair light for an instant longer as it does; my hair, blouse and the backdrop stay completely still. Camera: a locked-off tripod shot, no push, no pan. The four-light studio rig — hard key high-left, weak fill right, hair light behind, background light on the canvas — must hold its exact balance for the whole clip, so the shadow under my nose and the lighter halo of backdrop behind my head neither move nor change size. Keep the fine medium-format grain, the warm skin tones and the mild corner vignetting exactly as strong throughout. No sound, or at most a very faint studio-room hush — no music, no dialogue. Exclude any change to the mottled canvas pattern or any object entering frame. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still as a magazine-cover teaser, not as a scene with a new background. Keep my face exactly as it is for every frame — same features, skin tone, age and natural asymmetry — and the heavy period makeup must not reshape a feature or slide toward a generic cover-model face as I move. The only motion is a slow, natural blink and hair catching a little more light as my head tilts a fraction; the masthead, the cover lines and the price and barcode stay perfectly still, exactly as legible or illegible as in the still. Camera: a locked-off tripod shot, no push, no pan. The soft key above the lens and the hard hair light behind must hold their exact position for the whole clip, and the flat saturated backdrop must stay exactly as clashing with the outfit as in the still. Keep the oversaturated print ink and the faint halftone texture exactly as strong throughout. No sound, or at most a very quiet room hush — no music, no dialogue. Exclude any Devanagari text or any real magazine's name appearing. Output: 4 seconds, one unbroken shot, no cuts, vertical 3:4 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone and age, no slimming, lightening, smoothing or making me look younger — with zero drift as the clip plays. The only motion is a faint shift of the books held against my chest and a small movement of the pinned dupatta in the breeze, while the sunlit greenery beyond the corridor sways faintly out of focus; the notice board and the worn stone floor stay completely still. Camera: a locked-off tripod shot, or at most the faintest handheld sway, as if a classmate is holding the camera. The flat open-shade lighting must hold exactly as soft and even as the still for the whole clip, and the exterior beyond the corridor must stay blown out several stops brighter without resolving into detail. Keep the flat contrast, the faded warm 1985 colour and the grain exactly as strong throughout. Add distant campus chatter and birdsong, low in the mix — no dialogue, no music. Exclude any modern object entering frame. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone, age and natural asymmetry, no narrowing, enlarging, slimming or lightening — with zero drift as the clip plays. The only motion is the zari border catching hard metallic glints as I shift my weight by a small amount, the jasmine pinned in my hair moving a fraction, and the dim guests behind swaying faintly in the near-darkness they already sit in; nothing else changes. Camera: a locked-off tripod shot, no push, no pan. The hard direct flash must hold its exact intensity for the whole clip, so the flat lighting on my face, the hard specular glints off the zari and gold, and the steep falloff into darkness behind me all stay fixed, with the weak greenish tube-light rake unchanged. Keep the coarse night-film grain and the warm-magenta cast exactly as strong throughout. Add a low, indistinct reception murmur and a faint tube-light hum — no dialogue, no music with legible lyrics. Exclude any modern branding or phone light entering frame. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone, age and natural asymmetry, no slimming, lightening or smoothing. The only motion is a small, restrained bounce to a beat only I can hear, the boombox's twin cassette reels on my shoulder visibly turning at a steady real-time speed, and my permed hair moving with the motion; the painted wall and the weathered posters behind stay completely still. Camera: a locked-off tripod shot, or at most the faintest handheld sway, matching the street-snapshot feel of the still. The bright open daylight from behind the camera must hold its exact angle for the whole clip, so the hard-edged shadow I throw across the wall neither moves nor softens. Keep the punchy 1986 film contrast, the faded warm colour and the grain exactly as strong throughout. Add a tinny, muffled cassette beat playing from the boombox itself, low enough to read as diegetic, plus quiet street ambience — no clear lyrics, no dialogue. Exclude any Bluetooth speaker, earbuds or modern branding entering frame. Output: 6 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone and age, no slimming, lightening or smoothing — with zero drift as the clip plays. The only motion is a breeze moving my hair and the loose end of my saree by the same small amount already implied in the still, and a bicycle bell sounding once, far down the lane; the scooter itself stays parked and still on its side stand, with no wheels turning. Camera: a locked-off tripod shot, no push, no pan. The mid-morning sun must hold its exact angle for the whole clip, so the hard shadows on the lane and the bright specular streak along the front apron neither move nor soften. Keep the warm faded 1986 colour, the cyan shadows and the film grain exactly as strong throughout, and the scooter's period-correct silhouette must not change shape. Add the distant bicycle bell, birdsong and quiet residential ambience — no dialogue, no music. Exclude any modern scooter part or object entering frame. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone and age, no slimming, lightening, smoothing or beautifying, and no ageing me up or down. The only motion is a small continuation of the task at the counter, a thin curl of steam rising from the pan on the stove, and the light through the window grille flickering faintly as if a tree outside moves in the wind; the steel dabbas, the grinding slab and the shelves stay completely still. Camera: a locked-off tripod shot, no push, no pan. The single small window must remain the only light source for the whole clip, holding its exact falloff so my lit side stays gently bright and the far side of the kitchen stays exactly as deeply shadowed as the still, with no fill light creeping in. Keep the low shadow contrast, the slight warm cast and the film grain exactly as strong throughout. Add a distant utensil clink and birdsong through the window, low in the mix — no dialogue, no music. Exclude any microwave, mixer-grinder or modern packaging entering frame. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face exactly as it is for every frame — same features, skin tone, age and natural asymmetry — and keep coloured stage light confined to my hair and shoulders exactly as in the still, my face staying close to neutral and never reshaped by the colour. The only motion is the turn already implied completing itself: my raised arm finishes its arc and the sequinned gown catches the rim light as hard moving points, while the haze drifts slowly and steadily past the light truss above — nothing else changes pace. Camera: a slow, small arc around me at a fixed distance, the kind of restrained move a motorised slider produces, not a handheld shake. The one hard warm key and the strong coloured rim from behind must hold their exact angle and hue for the whole clip. Keep the coarse pushed-film grain and the halation blooming off the sequins and the rim exactly as strong throughout. Add a muffled, distant stage bassline and a faint crowd murmur, low enough to sit under the image — no legible lyrics, no dialogue. Exclude any modern stage screen, phone light or LED wall entering frame. Output: 6 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep both our faces exactly as they are for every frame — same bone structure, nose, eyes, lips, skin tone, age and natural asymmetry on each of us, anchored to the same side of frame as the still, with neither identity drifting toward the other's. The only motion is a slow, near-synchronised blink from both of us and our heads settling a fraction further into the pose, catching the hair light for an instant longer; our clothes, jewellery and the backdrop stay completely still. Camera: a locked-off tripod shot, no push, no pan. The four-light studio rig must hold its exact balance for the whole clip, so the offset height between our two heads, the shadow under each nose and the lighter halo of backdrop behind us all stay fixed. Keep the fine medium-format grain, the warm skin tones and the mild vignetting exactly as strong throughout. No sound, or at most a very faint studio-room hush — no music, no dialogue. Exclude any object entering frame or any change to the backdrop. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this hand-painted film poster as a teaser, not as live footage — both of us stay painted, not photorealistic, for every frame, with each painted face recognisably ours by position, left stays left, right stays right, and no proportion drifting toward a more generic or idealised face. The only motion is restrained and specific to the lower vignette: the painted rain keeps falling in the same streaked style as the still and the jeep's headlamps flicker once; in the upper two-thirds our painted expressions hold almost perfectly still, as if the artist's brushwork is settling rather than a scene playing out. Camera: a slow push on a slider toward the upper two hero faces, the same restraint a real trailer teaser would use, never fast enough to blur the painted brushwork into a photograph. Keep the visible brushwork, the heightened saturated colour and the hard-edged painted highlights exactly as strong throughout — the image must not sharpen into photorealism as it plays. Keep the halftone dots, the yellowed paper and the misregistered colour fringes exactly as strong for the full runtime. Add a low, distant film-orchestra swell and falling rain — no legible dialogue, no new title reveal beyond the still. Output: 6 seconds, one unbroken shot, no cuts, vertical 3:4 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep both our faces exactly as they are for every frame — same features, skin tone, age and natural asymmetry on each of us, anchored to the same side of frame as the still, with neither of us made to look more alike than we are. The only motion is the cold wind moving our hair and the shared shawl by the same small amount already implied in the still, our breath showing faintly in the air, and thin mist drifting slowly across the pine ridges behind us; our pose and the railing stay completely still. Camera: a slow, small pan across the ridgeline, not a push toward us. The flat overcast light must hold its exact quality for the whole clip — no golden-hour warmth may creep in as it plays, and the cold blue-cyan cast with its magenta-leaning highlights must stay exactly as the still describes it. Keep the low contrast and the film grain exactly as strong throughout. Add wind and distant birdsong, low in the mix — no dialogue, no music. Exclude any modern outdoor gear entering frame. Output: 6 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep both our faces exactly as they are for every frame — same features, skin tone, age and natural asymmetry on each of us, anchored to the same side of frame as the still — and keep every garland, the sehra strings and the dupatta exactly where they sit in the still, with nothing worn drifting to cover either face as we move. The only motion is the sacred fire beside us flickering and casting moving warm light on both our chins, the garlands swaying by a small amount with our breathing, and one of us turning a fraction further toward the other; nothing else changes. Camera: a locked-off tripod shot, no push, no pan. The hard direct flash and the fire's separate warm uplight must hold their exact balance for the whole clip, so the flat lighting on both faces and the steep falloff into near-dark stay fixed. Keep the coarse night-film grain and the warm-magenta cast exactly as strong throughout. Add a low, indistinct chant and the crackle of the sacred fire — no clear dialogue, no music with legible lyrics. Exclude any modern lighting entering frame. Output: 5 seconds, one unbroken shot, no cuts, vertical 9:16 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, as though the car has just rolled to a stop, not as a driving shot. Keep both our faces exactly as they are for every frame — same features, skin tone, age and natural asymmetry on each of us, anchored to the same side of frame as the still, with neither of us made to look more alike than we are. The only motion is the wind through the open window moving our hair a little further and the forearm resting on the window frame shifting slightly, while a single distant vehicle passes on the road behind, out of focus; the car itself, the dashboard and the seat between us stay completely still. Camera: a locked-off tripod shot, still framed on the open window from outside the car, exactly as the still. The hard roof-shadow line across the window opening and the road-bounce light lifting both our faces must hold their exact position for the whole clip. Keep the warm faded 1986 colour, the cyan shadows and the film grain exactly as strong throughout. Add idling engine tone and wind, low in the mix — no dialogue, no music. Exclude any modern dashboard element or seatbelt entering frame. Output: 5 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep both our faces exactly as they are for every frame — same features, skin tone, age and natural asymmetry on each of us, anchored to the same side of frame as the still, with neither of us made to look more alike than we are. The only motion is us settling a little closer on the sofa as a small, quiet shared smile forms, and the television screen behind us flickering faintly with a scan-line shimmer; the doily, the steel tumblers and the wall clock stay completely still. Camera: a locked-off tripod shot, no push, no pan. The direct on-camera flash exposure must hold exactly as it does in the still, so the two separate hard head-shadows on the wall behind us stay fixed in position and never merge or move independently of the head that casts each one. Keep the warm-yellow tungsten-mixed cast and the film grain exactly as strong throughout. Add quiet room tone and a faint television hum — no dialogue, no music. Exclude any flat-screen, remote or modern branding entering frame. Output: 5 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep both our faces exactly as they are for every frame — same features, skin tone, age and natural asymmetry on each of us, anchored to the same side of frame as the still — and rain, hair and shadow may move but neither face may ever fall into shadow, streak over, blur or drift out of focus. The only motion is the backlit rain continuing to fall in bright glowing streaks, our foreheads drifting a fraction closer, and water continuing to run from the already-wet fabric; nothing else changes. Camera: a very slow, small push on a slider, matching the scene's own stillness rather than a dramatic move. The hard front key keeping both faces bright and the strong backlight lighting each raindrop must hold their exact angle and intensity for the whole clip, so the hot rim on both our heads and shoulders neither dims nor drifts. Keep the cool blue shadows against the warm key, the halation around the lit rain and the crushed blacks exactly as strong throughout. Add falling rain and a distant rumble — no dialogue, no music with legible lyrics. Output: 6 seconds, one unbroken shot, no cuts, horizontal 16:9 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still — no two identities may drift toward each other and no age gap may narrow as the clip plays. The only motion is a near-synchronised slow blink across the group and every head settling a fraction further into the tiered pose, catching the hair light for an instant longer; nobody's clothes, jewellery or pose otherwise change. Camera: a locked-off tripod shot, no push, no pan. The broad studio rig — key, fill, hair light and background light — must hold its exact balance for the whole clip, so every face stays exactly as evenly lit as in the still and nobody at the edge of the tier falls into shadow. Keep the fine medium-format grain, the warm skin tones and the mild vignetting exactly as strong throughout. No sound, or at most a very faint studio-room hush — no music, no dialogue. Exclude any object entering frame or any change to the backdrop's mottled pattern. Output: 5 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position and the same relative body scale as the still — no adult may shrink and no child may grow as the clip plays. The only motion is a breeze moving clothing and hair across the group by the same small amount already implied in the still, and a single gulmohar leaf drifting past in the foreground; the Ambassador itself stays parked and still, with no wheels turning. Camera: a locked-off tripod shot, no push, no pan. The bright mid-morning sun must hold its exact angle for the whole clip, so the crisp shadows on the road and the hot specular streak along the chrome neither move nor soften, and anyone already squinting keeps squinting at the same intensity. Keep the warm faded 1986 colour, the cyan shadows and the film grain exactly as strong throughout. Add distant street ambience and birdsong, low in the mix — no dialogue, no music. Exclude any modern vehicle or phone entering frame. Output: 6 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still. The only motion is the television screen flickering with a faint, shifting scan-line shimmer and one person glancing back toward the camera while the rest stay turned toward the screen; nobody's pose otherwise changes, and screen light may fall across faces exactly as in the still but must never reshape a feature or shift a skin tone. Camera: a locked-off tripod shot, no push, no pan. The two-source lighting — the cool screen glow lifting the fronts of our faces from low and in front, and the warm dim tungsten bulb well behind — must hold its exact balance for the whole clip, so the upward shadows on the wall behind us stay fixed. Keep the coarse grain and the fighting blue-and-tungsten casts exactly as strong throughout; the screen itself must show only an indistinct glow, never a legible picture or logo. Add a faint television hum and quiet room tone — no legible television audio, no dialogue, no music. Output: 5 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still — every visible sign of age on the elders (grey or white hair, deep lines, folds, a stooped posture) must stay exactly as it appears, with nobody rejuvenated, smoothed or re-pigmented as they move, and no child rendered older. The only motion is the youngest child fidgeting slightly at the elders' feet and a breeze moving faintly through the potted plants on the verandah; the two eldest stay still and composed exactly as posed, while everyone standing behind shifts only by the smallest amount. Camera: a locked-off tripod shot, no push, no pan. The open-shade lighting must hold its exact soft, even, shadowless quality for the whole clip, with the sunlit garden beyond staying blown out several stops brighter. Keep the flat low contrast and the film grain exactly as strong throughout. Add birdsong and quiet household ambience, low in the mix — no dialogue, no music. Output: 6 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still — dappled light may shift across faces as the leaves above move, exactly as in the still, but no face may become unreadable as it does. The only motion is the child already mid-movement completing that same small gesture, the reaching adult's hand reaching the tiffin box it was already headed toward, and the dappled light pattern drifting slowly across the spread sheet as the tree above moves in the breeze; nobody else's pose changes. Camera: a locked-off tripod shot, or at most the faintest handheld sway, as if a family member is holding the camera. The punchy midday sun filtering through the tree must hold its exact pattern of hard bright patches and soft shadows for the whole clip, with the open sun beyond staying several stops hotter. Keep the punchy contrast and the film grain exactly as strong throughout. Add park ambience, birdsong and distant chatter, low in the mix — no dialogue directed at camera, no music. Output: 6 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still — the warm lamp light may flicker across faces exactly as in the still, but every face must stay clearly readable and no feature may be reshaped by the light as it moves. The only motion is the row of clay diyas continuing to burn, the held sparkler showering a few more sparks and casting its own moving light, and one child mid-laugh finishing that laugh; the rangoli on the ground stays completely still. Camera: a locked-off tripod shot, no push, no pan. The below-lighting from the lamp row must hold its exact direction for the whole clip, so the undersides of chins and lower cheeks stay lit and the shadows keep falling upward, with the sparkler's small hot point casting its own separate moving shadows. Keep the coarse night-film grain, the heavy warm-orange cast and the halation around every flame exactly as strong throughout. Add the crackle of the sparkler and distant, faint firecracker sounds — no dialogue, no music, no sung lyrics of any kind. Output: 6 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still — caps, hoods and the shared shawl may move in the wind exactly as in the still, but nothing may drift to newly cover any face. The only motion is the cold wind moving everyone's clothing and headwear by the same small amount already implied in the still, breath showing faintly in the air, and thin mist drifting across the pine slope behind the group; nobody's posture or expression otherwise changes. Camera: a locked-off tripod shot, no push, no pan. The flat overcast light must hold its exact quality for the whole clip — no golden-hour warmth may creep in, and the cold blue-cast shadows must stay exactly as the still describes them. Keep the low contrast and the film grain exactly as strong throughout. Add wind and distant birdsong, low in the mix — no dialogue, no music. Output: 6 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still — every arm stays connected to exactly the same person and shoulder it rests on in the still, with no new or missing limb appearing and no hand losing or gaining a finger as the group moves. The only motion is the shared laugh continuing — one head tipping back a little further, shoulders shaking faintly — while the group's loose, uneven posture holds exactly as posed; nobody's position on the steps changes. Camera: a locked-off tripod shot, or at most the faintest handheld sway, as if a friend is holding the camera rather than a tripod. The flat open-shade lighting must hold its exact soft, even quality for the whole clip, with the sunlit greenery beyond staying blown out. Keep the flat contrast and the film grain exactly as strong throughout. Add laughter and campus ambience, low in the mix — no directed dialogue, no music. Output: 6 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still — every arm and hand stays exactly as connected as it is in the still, with no new limb appearing. The only motion is the bare bulb overhead swaying by a very small amount, its warm light and the shadow it casts moving faintly with it, and the cassette reels on the tape recorder on the floor continuing to turn at a steady real-time speed; nobody's pose on the bunk or the floor changes. Camera: a locked-off tripod shot, no push, no pan. The single bare tungsten bulb must hold its exact position and harsh top-down angle for the whole clip, so the shadowed eye sockets and the hard falloff into the dark corners stay fixed. Keep the coarse tungsten-cast grain and the low shadow contrast exactly as strong throughout; the poster wall behind must stay exactly as illegible as in the still. Add a faint cassette hiss and quiet room tone — no legible song, no dialogue. Output: 5 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still — every arm and leg stays connected to exactly the same person as in the still, and every visible hand keeps five correctly formed fingers throughout. The only motion is the raised hand finishing a small toss of the taped ball and catching it again, the dust already lit by the sun continuing to drift, and one or two of us continuing to squint into the low light; nobody's stance otherwise changes. Camera: a locked-off tripod shot, or at most the faintest handheld sway, as if a friend's older brother is holding the camera. The low late-afternoon sun must hold its exact hard angle for the whole clip, so the long shadows across the lane and the bright rim on the sunward shoulders and hair neither move nor soften. Keep the punchy contrast and the film grain exactly as strong throughout. Add distant street sounds and children playing further off — no directed dialogue, no music. Output: 6 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still — every arm stays connected to exactly the same person as in the still, and every visible hand stays above the table edge or exactly as correctly formed as in the still. The only motion is the shared laughter continuing, the steel glasses on the table catching a faint afterglow from the waiter's flash as hands shift by a small amount, and the pendant lamp in the background flickering once; nobody's seating position changes. Camera: a locked-off tripod shot, no push, no pan. The hard direct cross-table flash must hold its exact falloff for the whole clip, so the near-to-far brightness gradient between us and the hard shadow behind each head on the booth backrest stay fixed. Keep the warm-magenta cast, the halation off the glasses and the film grain exactly as strong throughout. Add restaurant murmur and the clink of glasses, low in the mix — no directed dialogue, no music. Output: 5 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Count the people in the still and animate exactly that many, anchored to the same left-to-right position as the still — paper hats stay exactly where they sit in the still and must never slide down to cover a face as anyone moves, and every visible age stays exactly as it appears. The only motion is the lit candles on the cake flickering and guttering slightly, the birthday person leaning in by a small amount as if about to blow them out, and the person mid-clap finishing that single clap; the streamers and paper banner on the wall stay completely still. Camera: a locked-off tripod shot, no push, no pan. The two light sources — the hard on-camera flash flat-lighting every face, and the small warm candle glow lifting only the nearest chins — must hold their exact balance for the whole clip, so the hard head-shadows on the streamered wall stay fixed. Keep the warm-yellow cast, the halation around the candle flames and the film grain exactly as strong throughout. Add children's chatter and quiet laughter — no sung 'happy birthday'-style lyrics of any kind, no directed dialogue, no music. Output: 6 seconds, one unbroken shot, no cuts, horizontal 4:3 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep my face and my real visible age exactly as they are for every frame — the school uniform and setting must not make me look younger or older as I move, and no feature may be reshaped. The only motion is a single slow, natural blink and my hands settling a fraction on my thighs, with the slightly self-conscious smile holding steady throughout; my hair, tie and the backdrop stay completely still. Camera: a locked-off tripod shot, no push, no pan. The single portable flash fired into an umbrella must hold its exact angle and softness for the whole clip, so the defined shadow under my nose and the soft shadow on the backdrop behind my shoulder neither move nor sharpen. Keep the slightly flat contrast, the warm skin tones and the faint texture of matte print paper exactly as strong throughout. No sound, or at most a very quiet school-hall hush — no music, no dialogue. Exclude any change to the mottled canvas backdrop. Output: 4 seconds, one unbroken shot, no cuts, vertical 3:4 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep both our faces, our real visible ages and our height difference exactly as they are for every frame — anchored to the same position as the still, with neither face drifting toward looking related or the same age. The only motion is the child shifting very slightly against the adult's knee, the adult's hand staying steadily in place on the child's shoulder, and both of us settling a fraction further into the composed smile; our clothes and the backdrop stay completely still. Camera: a locked-off tripod shot, no push, no pan. The hard key adjusted for both our heights must hold its exact angle for the whole clip, so the catchlights in all four eyes and the shadow modelling on both faces stay fixed, with the shorter of us never falling into shadow. Keep the fine medium-format grain, the warm skin tones and the mild vignetting exactly as strong throughout. No sound, or at most a very faint studio-room hush — no music, no dialogue. Output: 5 seconds, one unbroken shot, no cuts, vertical 3:4 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
  ...
  },
  {
    ...
    videoPrompt: {
      promptText: `Animate this exact still, not a new scene. Keep both our faces and our real visible ages exactly as they are for every frame — anchored to the same position as the still, keeping every line and any grey hair on the older of us exactly as it appears, with neither face drifting toward looking the same age. The only motion is soft morning light shifting by a small amount as a breeze stirs both our pallus and loose hair; the doorframe, the rangoli and the dim interior behind stay completely still. Camera: a locked-off tripod shot, no push, no pan. The single-source morning light from outside must hold its exact angle and softness for the whole clip, so both our faces stay gently and evenly lit and the interior behind keeps falling off into the same deep shadow several stops darker than we are. Keep the gentle contrast, the warm faded colour and the film grain exactly as strong throughout. Add quiet morning ambience and distant birdsong, low in the mix — no dialogue, no music. Output: 5 seconds, one unbroken shot, no cuts, vertical 3:4 matching the still exactly, loop-safe.`,
      targetTools: ['Veo 3.1', 'Kling 3.0', 'Runway Gen-4.5'],
    },
    whyItWorks:
