...
export const meta: BlogPost = {
  ...
  description:
    'Real revenue, margin, and pricing data from indie AI wrapper builders — why everything costs $20/month, and what actually separates profitable wrappers.',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        [
          { text: 'Flat subscription vs. usage-based vs. hybrid.', bold: true },
        ...
        [
          { text: 'Photo AI vs. the $220 MRR wrapper.', bold: true },
          " Both use flat subscription pricing in a similar $20–300 range; the difference in outcome is almost entirely about product execution, market timing, and sustained marketing investment rather than pricing model choice — a useful reminder that pricing strategy alone doesn't rescue a product with weak product-market fit.",
        ],
        [
          {
            text: 'Seat-based vs. usage-based pricing for AI features specifically.',
            bold: true,
          },
          ' Seat-based pricing assumes value scales with headcount; Zuora\'s data shows this assumption breaking down for AI products because a single AI-powered "seat" can now do work that used to require several human ones, which is the direct cause of the documented shift toward usage and hybrid models.',
        ],
      ],
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'A solo founder launching an MVP wrapper', bold: true },
          ' starts with the category-anchor $20/month flat price to reduce buyer friction during early validation, with an explicit plan to introduce usage tiers once real cost-per-user data is available.',
        ],
        [
          '– ',
          { text: 'A wrapper builder whose API bill is eating margin', bold: true },
          ' implements multi-model routing — sending simple requests to a cheaper model and reserving the most expensive model for complex requests — following the same tactic Indie Hackers builders report using to cut costs by up to 70%.',
        ],
        [
          '– ',
          { text: 'A team pricing an agentic product', bold: true },
          " (one that runs multi-step, autonomous workflows rather than single request/response exchanges) builds in usage caps or per-workflow metering specifically because retry-loop and multi-step agent costs can spike unpredictably in ways a flat subscription price doesn't protect against.",
        ],
        [
          '– ',
          {
            text: 'A founder deciding between per-seat and usage-based pricing for a B2B AI tool',
            bold: true,
          },
          ' follows the broader SaaS-industry shift documented by Zuora, recognizing that if the AI features replace work multiple human seats used to do, per-seat pricing likely undercharges relative to delivered value.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          'Before locking in a price, run your numbers through the ',
          { text: 'Marketing ROI Calculator', href: '/seo/marketing-roi-calculator' },
          ' to sanity-check whether your acquisition spend and pricing tier actually produce a sustainable payback period, and use the ',
          { text: 'Invoice Generator', href: '/business/invoice-generator' },
          " once you're ready to formalize billing for paying customers. If you're still finalizing your product's name and positioning before launch, the ",
          { text: 'Business Name Generator', href: '/business/business-name-generator' },
          ' is a fast way to move past that step.',
        ],
        [
  ...
  faq: [
    ...
    {
      question:
        "What's a typical markup between API cost and subscription price for a light user?",
      answer: [
    ...
    {
      question:
        'Why do AI subscription cancellation rates look higher than typical SaaS?',
      answer: [
    ...
    {
      question:
        'Why did annual discounts on AI tools jump to 40-50% instead of the traditional ~20%?',
      answer: [
    ...
    {
      question:
        'Can a generic AI wrapper survive once the underlying chatbot itself gets good enough?',
      answer: [
    ...
    {
      question:
        'What building blocks give an AI wrapper a pricing moat instead of just copying competitors?',
      answer: [
    ...
    {
      question:
        'Is charging a premium over raw API cost ethically defensible for a wrapper?',
      answer: [
    ...
    {
      question:
        'How do I decide between usage-based, flat, and hybrid pricing for my AI wrapper?',
      answer: [
    ...
    {
      question:
        'How do I know if my AI wrapper is priced too low relative to its cost structure?',
      answer: [
    ...
    {
      question:
        'How do I price an agentic AI product differently from a simple chatbot wrapper?',
      answer: [
    ...
    {
      question:
        'My AI wrapper subscription has unprofitable unit economics despite decent revenue — why?',
      answer: [
    ...
    {
      question:
        'Is it worth switching from flat pricing to usage-based pricing mid-product-life?',
      answer: [
    ...
    {
      question:
        'Subscription vs. API/pay-as-you-go pricing — which should I choose for my AI tool?',
      answer: [
    ...
    {
      question:
        'Cursor vs. typical AI wrapper pricing — why does Cursor charge more and still grow?',
      answer: [
    ...
    {
      question:
        'Is it profitable to build wrapper apps compared to building a proprietary AI product?',
      answer: [
    ...
    {
      question:
        'Is it profitable to build wrapper apps compared to relying purely on affiliate/ad revenue instead of charging?',
      answer: [
    ...
    {
      question:
        'Is it profitable to build wrapper apps compared to consulting/services work using the same AI tooling?',
      answer: [
    ...
    {
      question:
        "My wrapper's paid-ad spend is outpacing new subscription revenue — what does that suggest?",
      answer: [
    ...
    {
      question:
        "My competitor undercuts my price and I can't figure out how they're profitable — what's likely happening?",
      answer: [
    ...
    {
      question:
        'AI subscription cancellations spiked right after a price increase — was that a mistake?',
      answer: [
    ...
    {
      question:
        'I raised prices to protect margin and now growth has stalled — what are my options?',
      answer: [
    ...
    {
      question:
        'My underlying API provider just raised prices — how fast should I react?',
      answer: [
    ...
    {
      question:
        'Is it worth paying for a dedicated AI SaaS pricing consultant instead of copying competitor pricing?',
      answer: [
    ...
    {
      question:
        'Should a bootstrapped founder charge from day one or offer a free tier first?',
      answer: [
    ...
    {
      question:
        'Is it worth building a custom billing/metering system for usage-based pricing, or use a third-party tool?',
      answer: [
    ...
    {
      question:
        'Should I price higher than the $20/month category anchor if my product delivers more value?',
      answer: [
    ...
    {
      question:
        "What's the single most important pricing decision for a new AI wrapper founder to get right first?",
      answer: [
