...
export const meta: BlogPost = {
  ...
  description:
    'How teams like Anthropic use AI agents for large-scale code migrations in practice — the real workflow, timelines, failure modes, and why one-shot migration fails.',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        [
          "Anthropic's own account of how its team runs large-scale code migrations with Claude Code describes a specific, six-stage process, and it's worth walking through each stage because the sequence itself is a meaningful part of why it works (",
          {
            text: 'claude.com/blog/ai-code-migration',
        ...
        [
          '1. ',
          { text: 'Build a rulebook.', bold: true },
          " Before any migration code is written, the team documents what can and can't be automatically translated — explicit mapping rules, known edge cases, and boundaries the agents need to respect. This front-loads the hardest judgment calls into a reference document rather than leaving each agent to improvise them independently.",
        ],
        [
          '2. ',
          { text: 'Stress-test on sample files.', bold: true },
          " The rulebook and approach get validated against a small, representative sample of the actual codebase before scaling up — catching gaps in the rulebook early, when they're cheap to fix, rather than after they've propagated across a large migration.",
        ],
        [
          '3. ',
          { text: 'Run parallel agent teams.', bold: true },
          ' Smaller, faster models handle the bulk translation work, while larger, more capable models review that output — a division of labor that uses cheaper compute for the high-volume mechanical work and reserves the more expensive, more careful review capacity for catching what the faster pass gets wrong.',
        ],
        [
          '4. ',
          { text: 'Fix compiler errors in agent loops.', bold: true },
          " Rather than a human manually fixing every compile failure, agents iterate automatically against the compiler's error output until the migrated code actually builds — a tight, automatable feedback loop that doesn't require human judgment for most mechanical fixes.",
        ],
        [
          '5. ',
          { text: 'Run smoke tests.', bold: true },
          ' Before the full test suite, a faster, lighter smoke-test pass catches obviously broken functionality early.',
        ],
        [
          '6. ',
          {
            text: 'Verify behavior matches the original via full test suites.',
            bold: true,
          },
          ' The final gate is running the complete existing test suite against the migrated code, confirming behavioral equivalence with the original codebase before merge.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          "Not every AI-assisted migration is a full cross-language port on the scale of Bun's Zig-to-Rust move. For narrower version migrations — for example, Java 11 to Java 17, or Spring Boot 2.x to 3.x — agents given a clear, well-scoped plan have completed large application migrations in as little as a single day, a meaningfully faster timeline than the multi-week efforts required for full language ports (",
          {
            text: 'ainativecompass.substack.com',
            href: 'https://ainativecompass.substack.com/p/migrating-legacy-code-with-ai-yes',
            external: true,
    ...
    },
    {
      ...
      body: [
        ...
        [
          "Worth flagging as a related, practical friction point for teams switching tools mid-project: there's no direct import path for migrating context or rules from Cursor to Claude Code specifically. Teams have to hand-carry accumulated project-specific context and rules into a `CLAUDE.md` manually, since Cursor's `.cursor/rules` and accumulated project context aren't treated as native Claude Code configuration (",
          {
            text: 'memorylake.ai',
            href: 'https://www.memorylake.ai/en/blogs/migrate-cursor-to-claude-code',
            external: true,
          },
          '). This is a real, documented limitation worth planning around if a migration project is also coinciding with a tooling switch.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        ...
        [
          "– The migration was driven partly by Zig's policy against AI-generated contributions following Anthropic's December 2025 acquisition of Bun, and was publicly criticized by Zig's creator, Andrew Kelley, as \"unreviewed slop\" — a genuinely contested case study, not a universally endorsed one (",
          {
            text: 'theregister.com',
            href: 'https://www.theregister.com/devops/2026/07/14/zig-creator-calls-buns-claude-rust-rewrite-unreviewed-slop/5270743',
            external: true,
        ...
        [
          '– A separate Python-to-TypeScript port of 165,000 lines was completed over a single weekend, cutting compile time from 30 minutes to about two seconds per release cycle (',
          {
            text: 'claude.com/blog/ai-code-migration',
            href: 'https://claude.com/blog/ai-code-migration',
            external: true,
        ...
        [
          '– Narrower version-upgrade migrations (e.g., Java 11 to 17, Spring Boot 2.x to 3.x) with a clear plan have been completed in as little as a single day (',
          {
            text: 'ainativecompass.substack.com',
            href: 'https://ainativecompass.substack.com/p/migrating-legacy-code-with-ai-yes',
            external: true,
        ...
        [
          '– In a comparative test of five AI coding agents on the same legacy codebase, Claude Code produced the most coherent migration plan and explained its reasoning for each change, while Cursor was faster specifically at local refactoring (',
          {
            text: '200oksolutions.com',
            href: 'https://www.200oksolutions.com/blog/5-ai-coding-agents-tested-on-legacy-codebase/',
            external: true,
        ...
        [
          '– Agents given an entire codebase to migrate in one shot reliably lose context and degrade in consistency as the task scales, and naively chunking without full-system visibility causes poor practice application, hallucinations, and scalability issues (',
          {
            text: 'ainativecompass.substack.com',
            href: 'https://ainativecompass.substack.com/p/migrating-legacy-code-with-ai-yes',
            external: true,
        ...
        [
          '– Agents can generate code calling stale or non-existent interfaces, inferring from training data or a limited context window rather than the current, actual codebase state — a documented risk especially in large monorepos (',
          {
            text: 'tianpan.co',
            href: 'https://tianpan.co/blog/2026-04-17-coding-agents-monorepo-context-window',
            external: true,
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Runtime and infrastructure teams', bold: true },
          ' pursuing full cross-language ports for performance or maintainability reasons, following the documented Bun Zig-to-Rust pattern.',
        ],
        [
          '– ',
          { text: 'Teams modernizing build/compile tooling', bold: true },
          ' via language ports specifically for developer-experience gains, following the documented Python-to-TypeScript example that cut compile time from 30 minutes to about two seconds.',
        ],
        [
          '– ',
          { text: 'Enterprise teams running routine version upgrades', bold: true },
          ' (Java, Spring Boot, and similar framework/runtime version bumps) using agent assistance for a much faster turnaround than a full language port would require.',
        ],
        [
          '– ',
          { text: 'Teams switching from Cursor to Claude Code mid-project', bold: true },
          " who need to explicitly hand-carry accumulated project rules and context into a new `CLAUDE.md`, since there's no automatic import path between the two tools' configuration systems.",
        ],
      ],
    },
    {
      ...
      body: [
        [
          '– ',
          {
            text: 'Asking an agent to migrate an entire codebase in one uninterrupted pass.',
            bold: true,
          },
          ' This reliably fails due to context loss as the task scales — the documented fix is a structured, staged process with an explicit rulebook, not a bigger single attempt.',
        ],
        [
          '– ',
          {
            text: 'Naively chunking a codebase into pieces without full-system context or an explicit rulebook.',
            bold: true,
          },
          ' This causes inconsistent practice application, more frequent hallucinations, and scalability issues — a different failure mode from one-shot migration, but still a failure mode.',
        ],
        [
          '– ',
          {
            text: 'Assuming a passing test suite before merge means the migration is fully correct.',
            bold: true,
          },
          ' Even the well-documented Bun migration, which passed its existing test suite before merge, still saw 19 post-merge regressions.',
        ],
        [
          '– ',
          {
            text: 'Skipping the "build a rulebook first" stage and relying on ad hoc prompting throughout the migration.',
            bold: true,
          },
          ' Documented best practice consistently favors structured, upfront instructions (e.g., a `CLAUDE.md`) over improvised, per-session prompting.',
        ],
        [
          '– ',
          {
            text: 'Trusting agent-generated code that references interfaces or APIs without verifying they still exist in the current codebase.',
            bold: true,
          },
          ' This is a documented, real risk, especially in monorepos where a shared interface may have changed elsewhere in the system.',
        ],
        [
          '– ',
          {
            text: 'Assuming Cursor project rules and context automatically transfer to Claude Code (or vice versa) when switching tools mid-migration.',
            bold: true,
          },
          " There's no direct import path — rules and context need to be hand-carried into the new tool's configuration format.",
        ],
        [
          '– ',
          {
            text: 'Treating a version upgrade and a full language port as the same scale of undertaking.',
            bold: true,
          },
          ' Version upgrades have been completed in as little as a day; full language ports take substantially longer even with a dedicated team and strong process.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          "If you're managing structured config, API payloads, or data files as part of a migration project, the ",
          { text: 'JSON Formatter & Validator', href: '/dev/json-formatter' },
          ' on tools.scult.in is a fast way to catch malformed structures during the process. For structuring migration-related prompts and rulebooks, see the ',
        ...
        [
          "If you're planning a migration on the scale described in this article and want the rulebook, staging, and validation work handled by a team with hands-on experience running exactly this kind of project, that's the core of what SCULT's ",
          {
            text: 'custom software development',
            href: SERVICE_CUSTOM_SOFTWARE.href,
            external: true,
          },
          ' service does — worth a conversation before committing engineering time to a one-shot approach that the evidence above suggests is likely to fail.',
        ],
      ],
    },
  ],
  faq: [
    ...
    {
      question:
        'Why does letting an AI agent migrate an entire codebase in one shot fail?',
      answer: [
    ...
    {
      question:
        'Is there a real risk of AI agents hallucinating APIs or interfaces during migration?',
      answer: [
    ...
    {
      question:
        'How should teams structure instructions (CLAUDE.md) for a migration project?',
      answer: [
    ...
    {
      question:
        'Can AI agents migrate specific version upgrades quickly, like Java or Spring Boot?',
      answer: [
    ...
    {
      question:
        "What's the biggest non-technical barrier to AI-assisted migration adoption?",
      answer: [
    ...
    {
      question:
        'Why do teams use parallel agent teams instead of a single agent for large migrations?',
      answer: [
    ...
    {
      question:
        'What measurable benefits did the Bun migration deliver beyond just porting the language?',
      answer: [
    ...
    {
      question:
        'Is a full language port the same scale of effort as a version upgrade migration?',
      answer: [
    ...
    {
      question:
        "How do you verify AI-generated migration code doesn't call stale or hallucinated interfaces?",
      answer: [
    ...
    {
      question:
        'How do you decide whether to attempt a full language port or a narrower version upgrade?',
      answer: [
    ...
    {
      question:
        'How do you choose between Claude Code, Cursor, and other agents for a migration project?',
      answer: [
    ...
    {
      question:
        'How do you migrate accumulated project context when switching from Cursor to Claude Code mid-project?',
      answer: [
    ...
    {
      question:
        'How do you stress-test a migration rulebook before committing to the full migration?',
      answer: [
    ...
    {
      question:
        'How do you use smaller and larger models together in a migration workflow?',
      answer: [
    ...
    {
      question:
        'AI migration agents vs. traditional automated migration scripts/tools — which is better for a legacy codebase?',
      answer: [
    ...
    {
      question:
        'Full language port vs. staying on the legacy language — is migration worth it?',
      answer: [
    ...
    {
      question:
        'Is Claude Code better than a general-purpose model prompted directly for migration work?',
      answer: [
    ...
    {
      question:
        "My AI agent's migrated code references a function that no longer exists — what happened?",
      answer: [
    ...
    {
      question:
        'My migration passed all existing tests but broke in production — is this normal?',
      answer: [
    ...
    {
      question:
        'My agent is losing track of earlier migration decisions as the codebase gets larger — what should I do?',
      answer: [
    ...
    {
      question:
        'My migrated code compiles but behaves differently from the original — how do I catch this?',
      answer: [
    ...
    {
      question:
        'I switched from Cursor to Claude Code mid-migration and lost my accumulated project context — is that expected?',
      answer: [
    ...
    {
      question:
        'Should I hire a specialist team for a large-scale AI-assisted code migration, or handle it in-house?',
      answer: [
    ...
    {
      question:
        'Is it worth paying for enterprise Claude Code support for a large migration project?',
      answer: [
    ...
    {
      question:
        'Should a startup attempt a full language port in-house, or bring in outside help?',
      answer: [
    ...
    {
      question:
        'How much engineering time should I budget for a large-scale AI-assisted migration?',
      answer: [
    ...
    {
      question:
        "What's the ROI of migrating a legacy codebase with AI agents versus staying on the current stack?",
      answer: [
    ...
    {
      question:
        'Should I use AI agents for a migration if my codebase is poorly documented or structured?',
      answer: [
    ...
    {
      question:
        "What's the biggest risk teams underestimate when planning an AI-assisted migration?",
      answer: [
    ...
    {
      question:
        "What's the single most important first step before starting an AI-assisted codebase migration?",
      answer: [
