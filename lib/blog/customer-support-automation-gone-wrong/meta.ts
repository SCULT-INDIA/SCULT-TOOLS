...
export const meta: BlogPost = {
  ...
  description:
    'Real cases — Klarna, Air Canada, Cursor — show what breaks when companies automate customer support too fast, and how to avoid the same mistakes.',
  ...
  sections: [
    {
      ...
      body: [
        ...
        [
          'By mid-2025, CEO Sebastian Siemiatkowski publicly reversed that framing. He acknowledged that the company had prioritized cost savings over service quality, and Klarna began rehiring and expanding its human support team again, describing the AI-first approach as a mistake rather than a milestone (',
          {
            text: 'Yahoo News, "A customer support AI went rogue"',
            href: 'https://www.yahoo.com/news/customer-support-ai-went-rogue-120000474.html',
            external: true,
          },
          '; ',
          {
            text: 'CMSWire',
            href: 'https://www.cmswire.com/customer-experience/ai-in-customer-service-billion-dollar-mistake-when-deployed-wrong/',
            external: true,
          },
          '). The reversal matters for two reasons distinct from the headline: first, it came from the company itself, not from a leaked internal memo or a disgruntled customer — this is a CEO retracting his own case study in public. Second, it happened after roughly 18 months of live production use at genuine scale, which rules out the "they just didn\'t try hard enough" explanation that vendors often reach for when a deployment goes wrong.',
        ],
        [
    ...
    },
    {
      ...
      body: [
        ...
        [
          ...
          {
            text: 'Forbes',
            href: 'https://www.forbes.com/sites/marisagarcia/2024/02/19/what-air-canada-lost-in-remarkable-lying-ai-chatbot-case/',
            external: true,
          },
          ').',
        ],
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Klarna (real, documented):', bold: true },
          " 700 agents' worth of AI-handled volume at 2.3 million conversations/month, followed by a public admission that speed of rollout outpaced quality, and a return to hiring humans.",
        ],
        [
          '– ',
          { text: 'Air Canada (real, documented, court record):', bold: true },
          " a chatbot inventing a bereavement-fare policy, an airline's failed legal defense that the bot was a separate entity, and a tribunal ruling that made the company pay for the bot's words.",
        ],
        [
          '– ',
          { text: 'Cursor (real, documented):', bold: true },
          ' an AI support agent inventing a device-limit policy to explain a bug, users cancelling over the fabricated rule, and a public apology plus a new labeling policy.',
        ],
        [
          '– ',
          {
            text: 'Shopify merchants (real, documented via community forum):',
            bold: true,
          },
          " merchants posting on Shopify's own community forum describing being routed through an AI chatbot that couldn't resolve their issue and made reaching a human deliberately hard (",
          {
            text: 'Shopify Community',
            href: 'https://community.shopify.com/t/shopify-misleading-merchants-about-support/258145',
            external: true,
          },
          ').',
        ],
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: '38.8% failure rate on fully AI-handled interactions', bold: true },
          ' — cited from Accenture research via Gleap\'s analysis; this is the clearest single number showing that "handled by AI" and "resolved" are not the same claim (',
          {
            text: 'Gleap',
            href: 'https://www.gleap.io/blog/ai-support-failures-lessons',
            external: true,
        ...
        [
          '– ',
          { text: '~90% of consumers report reduced loyalty', bold: true },
          ' when human support is removed from a channel, according to the same survey data — even when the AI itself responds quickly (Gleap).',
        ],
        [
          '– ',
          {
          ...
          ", against an estimated $30-40 billion in enterprise investment, per MIT's Project NANDA research reported by Fortune — a useful caution against assuming that AI support spend automatically translates to ROI (",
          {
            text: 'Fortune',
        ...
        [
          '– ',
          { text: 'CAD $812.02', bold: true },
          ' — the actual damages and fees awarded to the Air Canada chatbot claimant, a small number that established a large legal principle (CBC News).',
        ],
        [
          '– ',
          {
            text: "~700 human agents' worth of volume, 2.3 million conversations/month",
            bold: true,
          },
          " — Klarna's own reported scale for its AI support system before the reversal (Yahoo News; CMSWire).",
        ],
        [
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          {
            text: 'Measuring success by volume handled, not by issues resolved.',
            bold: true,
          },
          " Klarna's headline metric (2.3 million conversations/month) described throughput, not outcomes — and the outcome gap is what forced the reversal.",
        ],
        [
          '– ',
          {
            text: 'Letting the bot state specific policies with confidence instead of deferring to a human on anything not explicitly verified.',
            bold: true,
          },
          ' Both Air Canada and Cursor\'s failures came from the bot inventing specific, confident, wrong answers rather than saying "I\'m not certain, let me connect you with someone."',
        ],
        [
          '– ',
          { text: 'Assuming disclaimers protect the company.', bold: true },
          " Air Canada's tribunal defense — that the bot was a separate legal entity — failed. A generic disclaimer buried in terms of service is unlikely to fare better in a similar case.",
        ],
        [
          '– ',
          { text: 'Making human escalation slow or hidden.', bold: true },
          " Every case in this article involves a customer who couldn't get a fast, clear path to a human when the bot's answer didn't work.",
        ],
        [
          '– ',
          { text: 'Not labeling AI-generated responses as such.', bold: true },
          ' Cursor\'s incident specifically involved a customer believing a human named "Sam" had made a considered decision, which amplified the sense of betrayal once the truth came out.',
        ],
      ],
    },
    {
      ...
      body: [
        [
          '1. ',
          { text: "Scope the bot's authority narrowly and explicitly.", bold: true },
          ' Let it answer order status, general FAQs, and account basics; route anything touching a specific written policy (refunds, fare rules, subscription terms) to a human or a verified, hard-coded lookup rather than free-form generation.',
        ],
        [
          '2. ',
          { text: 'Always disclose that a response is AI-generated', bold: true },
          ", in the message itself — not buried in a terms-of-service link. Cursor's post-incident fix is the direct evidence this works as damage control; doing it before an incident is cheaper.",
        ],
        [
          '3. ',
          { text: 'Build a visible, fast human-escalation path', bold: true },
          ' and measure how long it actually takes customers to reach one, not just whether the option technically exists.',
        ],
        [
          '4. ',
          { text: 'Track resolution rate, not just conversations handled.', bold: true },
          ' If "resolved by AI" and "conversation ended" are the same metric in your dashboard, you can\'t see the Klarna-style gap coming.',
        ],
        [
          '5. ',
          {
            text: 'Treat any hallucinated or contradicted statement as a defect to be logged and fixed, not an isolated anomaly',
            bold: true,
          },
          ' — Air Canada and Cursor both had a single incident become a legal or PR event because there was no process to catch and correct fabricated claims before they reached customers at scale.',
        ],
        [
          '6. ',
          {
            text: 'Pilot on a single, low-stakes queue before rolling out company-wide',
            bold: true,
          },
          ', and set an explicit rollback trigger (e.g., resolution rate below X%, loyalty score drop of Y points) rather than treating the rollout as a one-way door.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          "If you're mapping out prompts for how a support team should actually word AI-assisted responses, escalation scripts, or policy-safe FAQ language, the ",
          ...
          ' are built for exactly this kind of scoping work before you touch a production deployment.',
        ],
        [
          "If your team is weighing how far to take AI support automation — where to draw the line between a scripted assistant and something closer to an autonomous agent, and how to build in the escalation and audit safeguards this article's cases show are missing when things go wrong — that's a scoping conversation worth having with a team that builds ",
          {
            text: 'AI agents and automation',
            href: SERVICE_AI_CONSULTING.href,
            external: true,
          },
          ' for a living, before a rollout decision turns into an incident report.',
        ],
      ],
    },
  ],
  faq: [
    ...
    },
    {
      ...
      answer: [
        "He is Klarna's CEO, who publicly acknowledged in 2025 that the company's AI-first support strategy prioritized cost over quality (",
        {
          text: 'Yahoo News',
          href: 'https://www.yahoo.com/news/customer-support-ai-went-rogue-120000474.html',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Cursor, the AI-powered coding tool, whose support agent named Sam fabricated a device-limit policy in April 2025 (',
        {
          text: 'The Register',
          href: 'https://www.theregister.com/2025/04/18/cursor_ai_support_bot_lies/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Air Canada, in a 2024 Canadian Civil Resolution Tribunal ruling (',
        {
          text: 'CBC News',
          href: 'https://www.cbc.ca/news/canada/british-columbia/air-canada-chatbot-lawsuit-1.7116416',
          external: true,
    ...
    {
      question:
        'Can a chatbot be considered a separate legal entity from the company that deploys it?',
      answer: [
    ...
    {
      question:
        "Why did Klarna's AI-first strategy fail even though the bot handled millions of conversations successfully?",
      answer: [
    ...
    {
      question:
        'What percentage of fully-AI-handled support interactions fail to resolve the issue?',
      answer: [
        "Roughly 38.8%, per Accenture research cited by Gleap's analysis of AI support failures (",
        {
          text: 'Gleap',
          href: 'https://www.gleap.io/blog/ai-support-failures-lessons',
          external: true,
    ...
    {
      question:
        'Does removing human agents actually save money once you account for the failures?',
      answer: [
    ...
    {
      question:
        "What's the difference between an AI chatbot and an AI agent in a support context?",
      answer: [
    ...
    {
      question:
        'How do I check whether my own support bot has stated an incorrect policy?',
      answer: [
    ...
    {
      question:
        'How do I label AI-generated responses without sounding robotic or off-putting to customers?',
      answer: [
    ...
    {
      question:
        'How do I train a support bot to say "I don\'t know" instead of guessing?',
      answer: [
    ...
    {
      question:
        "How do I audit my AI support vendor's actual resolution rate, not just volume handled?",
      answer: [
    ...
    {
      question:
        'How do I communicate an AI support rollout to customers without triggering distrust?',
      answer: [
    ...
    {
      question:
        "How do I prevent an AI bot from fabricating a policy under pressure (e.g., a bug it can't otherwise explain)?",
      answer: [
    ...
    {
      question:
        'Is there research showing AI-only interactions cost more in the long run than blended human-AI support?',
      answer: [
    ...
    {
      question:
        'What\'s the relationship between AI support failures and "cognitive debt" in AI research generally?',
      answer: [
    ...
    {
      question:
        'Is there a standard framework for evaluating AI support vendor claims before buying?',
      answer: [
    ...
    {
      question:
        'How does this topic relate to companies that build genuinely autonomous support agents versus scripted chatbots?',
      answer: [
    ...
    {
      question:
        "Klarna's AI support vs. its human support — what changed before and after the reversal?",
      answer: [
    ...
    {
      question:
        "Air Canada's chatbot vs. a human travel agent — who would have caught the bereavement-fare error?",
      answer: [
    ...
    {
      question:
        "Cursor's AI support bot vs. its own product's coding accuracy — is there a contradiction?",
      answer: [
    ...
    {
      question:
        "Shopify's AI chatbot vs. direct merchant support — which do merchants prefer, per the forum evidence?",
      answer: [
    ...
    {
      question:
        'My AI chatbot gave a customer wrong information about a discount — what should I do first?',
      answer: [
    ...
    {
      question:
        'Customers are canceling after our AI support bot said something false — how do we contain it?',
      answer: [
    ...
    {
      question:
        "Our AI support resolution rate looks fine in the dashboard but complaints are rising — what's the disconnect?",
      answer: [
    ...
    {
      question:
        'We removed human support entirely and now see churn — is that reversible?',
      answer: [
    ...
    {
      question:
        'Our support bot keeps escalating everything to a human, defeating the point of automating — how do we fix that without reintroducing the hallucination risk?',
      answer: [
    ...
    {
      question:
        'Should a small business buy an "AI-first" support platform or a "human-plus-AI" one?',
      answer: [
    ...
    {
      question:
        'What questions should I ask an AI customer support vendor before signing a contract?',
      answer: [
    ...
    {
      question:
        'Is there a vendor or platform specifically built around human handoff rather than replacement?',
      answer: [
    ...
    {
      question:
        'How much should a small company budget for a hybrid AI-plus-human support rollout versus a full AI replacement?',
      answer: [
    ...
    {
      question:
        'Where can I get help designing an AI support rollout that avoids these failure patterns?',
      answer: [
