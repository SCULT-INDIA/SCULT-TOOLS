...
export const meta: BlogPost = {
  ...
  pillar: 'roundup',
  title:
    "AI Agent vs Chatbot: What Actually Counts as an Agent (and What's Just Agent Washing)",
  h1: 'AI agent vs chatbot: what actually counts as an agent',
  targetKeyword: 'ai agent vs chatbot',
  description:
    "Gartner found only ~130 of thousands of self-described 'AI agent' vendors are genuinely agentic. Here's the real definition, per Anthropic's own framework.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        [
          "Anthropic's practical recommendation follows directly from this: start with the simplest solution — typically a workflow — and only add genuine agency when the added flexibility is worth the added latency, cost, and compounding-error risk that comes with letting a model direct its own multi-step process (",
          {
            text: 'Anthropic',
            href: 'https://www.anthropic.com/engineering/building-effective-agents',
            external: true,
          ...
          '; ',
          {
            text: 'analysis via Mer.vin',
            href: 'https://mer.vin/2026/05/when-not-to-build-ai-agents-anthropics-workflow-vs-agent-playbook/',
            external: true,
          },
          "). Most production systems, per this guidance, don't actually need full autonomy — which is itself a useful signal for evaluating vendor claims: a genuine need for agentic autonomy should be the exception a vendor can justify, not the default marketing frame every product reaches for.",
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          ...
          {
            text: 'Entagl',
            href: 'https://www.entagl.com/blog/agent-washing-real-ai-agent-vs-rebranded-chatbot',
            external: true,
          },
          ')?',
        ],
        [
          "There's also a security dimension worth taking seriously in this evaluation, and it's not a marketing nuance. A chatbot that produces a wrong or unsafe piece of text is dangerous in a bounded way — the damage is limited to bad information reaching a user. A genuinely agentic system that can take real actions — deleting data, calling paid APIs, executing transactions — changes the entire threat model, because a reasoning error doesn't just produce bad text, it produces a bad action that already happened (",
          {
            text: 'Hacker News',
            href: 'https://news.ycombinator.com/item?id=44623207',
            external: true,
          },
          '). This is a real, practical reason "is this actually an agent" is worth answering precisely before deployment, not just a semantic argument about labeling.',
        ],
      ],
    },
    {
      ...
      body: [
        [
          '– ',
          { text: "Real, per Anthropic's own guidance:", bold: true },
        ...
        [
          '– ',
          { text: "Real, per Gartner's framing:", bold: true },
          ' a RAG-based document search tool marketed as an "autonomous knowledge agent" — genuinely useful for retrieval, but not agentic by the autonomy definition, since it doesn\'t independently decide on and execute multi-step actions toward a goal.',
        ],
        [
          '– ',
          { text: 'Illustrative, not a documented case:', bold: true },
          ' picture a scheduling tool that a vendor calls an "AI agent" but that, on inspection, only ever follows one fixed sequence — check calendar, propose three times, send email — with no branching decision-making based on what it finds. That\'s a workflow by Anthropic\'s definition, however capable it looks in a demo.',
        ],
      ],
    },
    {
      ...
      body: [
        [
          '– ',
          { text: '~130 out of thousands', bold: true },
          ' of vendors marketing "AI agents" were assessed by Gartner as genuinely agentic in 2025 — roughly a 95% mislabeling rate across the category (Xpert.digital).',
        ],
        [
          '– ',
          { text: 'Only ~17% of organizations', bold: true },
          ' report having actually deployed AI agents, versus ',
          { text: 'over 60%', bold: true },
          " expecting to within two years, per Gartner's 2026 CIO survey (DigitalApplied) — a large intent-to-deployment gap.",
        ],
        [
          '– ',
          { text: 'Five named workflow patterns', bold: true },
          ' — prompt chaining, routing, parallelization, orchestrator-workers, evaluator-optimizer — are documented by Anthropic as predefined-path systems that fall short of full agentic autonomy, despite often looking sophisticated (Anthropic).',
        ],
        [
          '– Gartner predicts ',
          {
            text: 'over 40% of agentic AI projects will be canceled by the end of 2027',
            bold: true,
          },
          ', citing escalating costs, unclear business value, and inadequate risk controls — tied specifically to unclear value and capabilities mislabeled at purchase time (Gartner; DigitalApplied).',
        ],
        [
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Assuming tool access equals agency.', bold: true },
          " A chatbot that calls a function to check an order status is still a chatbot if a human or a script decided when to call it — the deciding factor is who's directing the process.",
        ],
        [
          '– ',
          {
            text: 'Buying based on the word "agent" in a product name or pitch deck',
            bold: true,
          },
          ', rather than asking the specific autonomy questions (who decides the next step, can it act across systems, is it goal-directed) that separate a real agent from a workflow.',
        ],
        [
          '– ',
          {
            text: 'Treating a well-built workflow as inferior to "a real agent."',
            bold: true,
          },
          " Anthropic's own guidance recommends workflows as the right default for most production systems — the mistake is mislabeling one as the other, not choosing one over the other.",
        ],
        [
          '– ',
          {
            text: 'Underestimating the security implications of genuine autonomy.',
            bold: true,
          },
          ' Evaluating a system\'s "agent" claim only on capability, without asking what happens if it takes a wrong action rather than just generates wrong text, misses the threat-model shift that comes with real agency.',
        ],
        [
          '– ',
          {
            text: 'Assuming a RAG-based product is automatically an agent because it\'s "AI-powered" and does something impressive.',
            bold: true,
          },
          " Retrieval and generation, however sophisticated, aren't the same as autonomous multi-step decision-making.",
        ],
      ],
    },
    {
      ...
      body: [
        [
          '1. ',
          {
            text: 'Ask directly: who decides what happens next — the model, or a predefined path a developer wrote?',
            bold: true,
          },
          " This single question, more than any feature list, separates an agent from a workflow per Anthropic's definition.",
        ],
        [
          '2. ',
          {
            text: 'Ask whether the system can act across multiple systems/tools autonomously',
            bold: true,
          },
          ', not just retrieve information or respond within one bounded interface.',
        ],
        [
          '3. ',
          {
            text: 'Start with the simplest architecture that solves the actual problem',
            bold: true,
          },
          ", per Anthropic's own recommendation — don't reach for agentic autonomy by default just because a vendor's pitch assumes you should.",
        ],
        [
          '4. ',
          {
            text: 'Weigh the added latency, cost, and error-compounding risk of genuine agency',
            bold: true,
          },
          ' against the flexibility it buys you, explicitly, before committing to an "agent" architecture over a workflow.',
        ],
        [
          '5. ',
          {
            text: 'Treat the security implications of real autonomy as a first-order evaluation criterion',
            bold: true,
          },
          ', not an afterthought — a system that can take real actions needs a different risk review than one that only generates text.',
        ],
        [
          '6. ',
          {
            text: "Use a buyer's scorecard (autonomy, goal-orientation, adaptive tool selection, cross-system action) rather than trusting the vendor's own label",
            bold: true,
          },
          ', given the documented ~95% mislabeling rate Gartner found across the category.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          ...
          ' is a practical place to see the difference between workflow-style prompting (fixed sequences) and genuinely agentic prompt design (dynamic, self-directed tool use) in practice, rather than just in theory.',
        ],
        [
  ...
  faq: [
    ...
    {
      question:
        'What percentage of AI agents on the market are genuinely real, per Gartner?',
      answer: [
    ...
    {
      question:
        'What are the five workflow patterns Anthropic describes before recommending full agents?',
      answer: [
    ...
    {
      question:
        'Why does the security threat model change once a system is a true agent rather than a chatbot?',
      answer: [
    ...
    {
      question:
        'What\'s the practical risk of buying a "workflow" while believing you bought an "agent"?',
      answer: [
    ...
    {
      question:
        'What\'s the relationship between "autonomy" and "goal-orientation" in defining an agent?',
      answer: [
    ...
    {
      question:
        'How do I evaluate the security risk of a genuinely agentic system before deploying it?',
      answer: [
    ...
    {
      question:
        'How do I build a genuinely agentic customer support system rather than a chatbot with tools?',
      answer: [
    ...
    {
      question:
        'How do I explain the agent-vs-workflow distinction to a non-technical stakeholder?',
      answer: [
    ...
    {
      question:
        "How do I audit my own product's marketing claims for agent-washing risk?",
      answer: [
    ...
    {
      question:
        'What percentage of RAG products get marketed with agent-washing language?',
      answer: [
    ...
    {
      question:
        'Is there a certification or audit process to verify an "AI agent" claim?',
      answer: [
    ...
    {
      question:
        'Is multi-agent orchestration (multiple LLMs coordinating) a distinct category from a single agent?',
      answer: [
    ...
    {
      question:
        'Does an agent need to use multiple tools to qualify as an agent, or can it use just one?',
      answer: [
    ...
    {
      question:
        "AI agent vs. AI chatbot vs. LLM workflow — what's the practical difference in production?",
      answer: [
    ...
    {
      question:
        'Anthropic agents vs. workflows — which does Anthropic recommend building first?',
      answer: [
    ...
    {
      question:
        'Agentic workflow vs. autonomous agent — is there a meaningful difference, or is it just terminology?',
      answer: [
    ...
    {
      question:
        'How does a real AI agent compare to traditional RPA (robotic process automation)?',
      answer: [
    ...
    {
      question:
        'How does a genuine agent compare to a simple AI assistant (e.g., an email autocomplete feature)?',
      answer: [
    ...
    {
      question:
        'I bought a product marketed as an "AI agent" but it only ever follows the same fixed steps — is that expected?',
      answer: [
    ...
    {
      question:
        'My team built what we call an "agent" but it can\'t handle any situation outside its script — did we build an agent?',
      answer: [
    ...
    {
      question:
        'Our "AI agent" keeps taking actions we didn\'t want because it has too much autonomy — how do we fix that?',
      answer: [
    ...
    {
      question:
        'Customers keep asking if our product is a "real" agent and we\'re not sure how to answer — what should we say?',
      answer: [
    ...
    {
      question:
        'We\'re getting pushback that our "agent" is just a chatbot with a plugin — is that a fair criticism?',
      answer: [
    ...
    {
      question:
        'What questions should I ask a vendor before trusting their "AI agent" claim?',
      answer: [
    ...
    {
      question:
        'Is it worth paying a premium for a "true" agentic product over a cheaper workflow-based one?',
      answer: [
    ...
    {
      question:
        'How do I avoid buying (or building) an agent-washed product for my team?',
      answer: [
    ...
    {
      question:
        'Where can I get help figuring out whether my use case actually needs a real agent or just a well-built workflow?',
      answer: [
