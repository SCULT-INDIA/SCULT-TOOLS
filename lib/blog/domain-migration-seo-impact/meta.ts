...
export const meta: BlogPost = {
  ...
  description:
    "Changing domains causes a temporary ranking dip, not a penalty. Here's the real timeline, the redirect rules, and the mistakes that turn a dip into a disaster.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        [
          { text: '301 vs. 302 redirect.', bold: true },
          ' 301 = permanent, transfers ranking signal, correct for domain migrations. 302 = temporary, tells Google to keep the old URL as canonical, wrong for a permanent move. Using a 302 during a migration is one of the more common ways a "temporary" ranking dip turns into a much longer one.',
        ],
        [
          { text: 'Subdomain vs. subdirectory migration.', bold: true },
          ' Both require the same redirect and sitemap discipline. The practical difference is usually about how Google was already crawling and trusting that subdomain beforehand — a subdomain Google already indexed as effectively part of the main site tends to transfer more smoothly than one it treated as a separate, less-trusted property.',
        ],
        [
          { text: 'Change of Address tool: needed vs. not needed.', bold: true },
          ' Needed for domain-to-domain or subdomain-to-subdomain moves. Not needed for HTTP→HTTPS, www vs non-www on the same domain, or path changes within the same domain — these are handled through standard redirects and don\'t require Google to be told a "site move" occurred at the domain level.',
        ],
        [
          {
            text: "Google's guidance vs. general SEO-industry recovery estimates.",
            bold: true,
          },
          " Google's documentation focuses narrowly on the technical reindexing timeline. Industry publications extend that into a broader traffic-recovery timeline, which is a related but distinct measurement — reindexing is necessary for recovery, but recovery also depends on factors outside Google's technical documentation, like whether the new domain carries any negative history of its own.",
        ],
      ],
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Full rebrand', bold: true },
          ': a business changes its name and needs every URL to move to a new domain while preserving as much existing ranking value as possible — the scenario this article centers on.',
        ],
        [
          '– ',
          { text: 'HTTPS migration', bold: true },
          ": a site moving from HTTP to the same domain over HTTPS doesn't need the Change of Address tool, but still benefits from the same redirect and sitemap discipline described above, scaled down to a same-domain move.",
        ],
        [
          '– ',
          { text: 'Platform replatform', bold: true },
          ': moving from one CMS or e-commerce platform to another often changes URL structures even without changing the domain, which triggers many of the same redirect-mapping requirements as a full domain migration.',
        ],
        [
          '– ',
          { text: 'Agency handling a client migration', bold: true },
          ": agencies managing this process for clients need to set expectations up front about the few-weeks-to-months timeline, specifically so a client doesn't panic at week two and demand a rollback before the process has had time to work.",
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          'Once your migration is live, run the new domain through the ',
          { text: 'Website Speed Test', href: '/seo/website-speed-test' },
          " to confirm the move didn't introduce a performance regression alongside the URL changes — page speed is one of the technical signals that can compound a migration dip if it's overlooked. If you're documenting the migration plan or briefing a technical writer on the redirect strategy, the ",
          { text: 'SEO & GEO prompts', href: '/prompts/seo-geo' },
          ' collection is a useful starting point for structuring that plan clearly.',
        ],
        [
          "If you're planning a full replatform or rebrand and want the redirect mapping, sitemap regeneration, and Search Console setup handled by people who do this regularly rather than as a one-off, that's a reasonable moment to have a conversation with a ",
          { text: 'web development', href: SERVICE_WEB_DEVELOPMENT.href, external: true },
          ' team — the technical execution described throughout this article is exactly where migrations succeed or quietly go wrong.',
        ],
      ],
    },
  ],
  faq: [
    ...
    {
      question:
        'How long does it take Google to reindex a site after a domain migration?',
      answer: [
    ...
    {
      question:
        'Should I use rel=canonical in addition to 301 redirects during a migration?',
      answer: [
    ...
    {
      question:
        'Migrating to HTTPS vs. migrating to a new domain — which carries more SEO risk?',
      answer: [
    ...
    {
      question:
        'Manual migration vs. using a migration/redirect-management tool — which is safer?',
      answer: [
    ...
    {
      question:
        "Google is showing my old domain's URLs in search results weeks after migration — why?",
      answer: [
    ...
    {
      question:
        'I accidentally left staging noindex tags live after launch — how bad is this?',
      answer: [
    ...
    {
      question:
        'Is it worth paying for a redirect-mapping tool for a large site migration?',
      answer: [
    ...
    {
      question:
        'What should I look for in a web development partner handling a migration?',
      answer: [
