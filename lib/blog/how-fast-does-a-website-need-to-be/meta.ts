...
export const meta: BlogPost = {
  ...
  pillar: 'playbook',
  title:
    'How Fast Does a Website Need to Be? Core Web Vitals Thresholds and Diminishing Returns',
  h1: 'How fast does a website actually need to be?',
  targetKeyword: 'how fast does a website need to be',
  description:
    'The real Core Web Vitals thresholds, where speed optimization hits diminishing returns, and how a slow landing page can quietly wreck a Google Ads campaign.',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        [
          { text: 'LCP vs. INP vs. CLS.', bold: true },
          ' LCP measures perceived loading speed, INP measures interaction responsiveness, and CLS measures visual stability — three genuinely different dimensions of "fast," meaning a site can pass one and fail another (a page that loads quickly but jumps around as ads inject, or one that appears fast but lags badly on click, both fail the overall Core Web Vitals bar despite looking fine on a single metric).',
        ],
        [
          { text: 'Lab data vs. field data.', bold: true },
          ' Lab data is a controlled, repeatable Lighthouse snapshot useful for diagnosing and verifying fixes; field data is real-user Chrome UX Report data that actually determines page-experience signals — treating a good lab score as proof of a good real-world experience is a common and consequential mistake.',
        ],
        [
          { text: 'PageSpeed score vs. real user experience.', bold: true },
          " A high PageSpeed/Lighthouse score correlates with but doesn't guarantee a good real-user experience, since the lab test can't capture the full variety of devices, networks, and connection quality actual visitors bring — field data is the only reliable confirmation.",
        ],
      ],
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'A marketing team running Google Ads campaigns', bold: true },
          ' adds landing-page performance monitoring (score, TBT, fully loaded time) as a standing check alongside their usual campaign metrics, specifically to catch the kind of silent, spend-throttling slowdown GTmetrix documents before it shows up as a mysterious lead-volume drop.',
        ],
        [
          '– ',
          {
            text: 'A small business owner who already optimized images and hosting',
            bold: true,
          },
          " and is now stuck deciding whether to invest further in speed work checks their current LCP/INP/CLS numbers against the 75th-percentile field-data thresholds first — if already comfortably inside them, that's evidence to redirect further effort elsewhere rather than chasing diminishing sub-second gains.",
        ],
        [
          '– ',
          { text: 'A developer auditing a client site', bold: true },
          " runs both a Lighthouse lab test (to diagnose specific technical issues) and pulls the client's Search Console Core Web Vitals field-data report (to confirm what real visitors are actually experiencing) before recommending a scope of work, rather than quoting a fix based on lab data alone.",
        ],
        [
          '– ',
          { text: 'An ecommerce team preparing for a high-traffic sale', bold: true },
          ' treats the Google Ads death-spiral risk as a reason to stress-test landing pages under simulated peak load in advance, not just under normal traffic conditions, given how quickly Smart Bidding can react to a slowdown.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          'Run your site through the ',
          { text: 'Website Speed Test', href: '/seo/website-speed-test' },
          ' tool to check your current LCP, INP, and CLS numbers against the thresholds covered above, and re-check after any significant site change to catch regressions before they show up as a mysterious drop in conversions or ad performance.',
        ],
        [
  ...
  faq: [
    ...
    {
      question:
        'Why measure Core Web Vitals at the 75th percentile instead of the average?',
      answer: [
    ...
    {
      question:
        'My landing page slowed down and my Google Ads spend dropped — is that related?',
      answer: [
    ...
    {
      question:
        'My PageSpeed score dropped after a routine update — what should I check?',
      answer: [
    ...
    {
      question:
        'Is there a point where more speed optimization stops helping conversions?',
      answer: [
    ...
    {
      question:
        'PageSpeed score vs. real user experience — how much do they actually correlate?',
      answer: [
    ...
    {
      question:
        'My performance score is stuck around 80% despite multiple optimization rounds — is that a problem?',
      answer: [
    ...
    {
      question:
        "My site's average load time looks great but Search Console still shows failing Core Web Vitals — why?",
      answer: [
    ...
    {
      question:
        "My landing page conversions dropped and I can't find a marketing cause — could speed be the issue?",
      answer: [
    ...
    {
      question:
        "My developer says further speed optimization isn't worth it anymore — how do I know if that's true?",
      answer: [
    ...
    {
      question:
        'My site scores differently in PageSpeed Insights depending on when I test it — is that normal?',
      answer: [
    ...
    {
      question:
        "My CLS score is bad but my page doesn't look like it's shifting — what am I missing?",
      answer: [
    ...
    {
      question:
        'Is it worth paying for an ongoing performance monitoring service, or is a manual check enough?',
      answer: [
    ...
    {
      question:
        'Should a small business prioritize Core Web Vitals or other SEO factors first?',
      answer: [
    ...
    {
      question:
        'Should I test my site speed differently for Google Ads landing pages versus regular content pages?',
      answer: [
    ...
    {
      question:
        'Is it worth investing in a CDN if my site is already inside Core Web Vitals thresholds?',
      answer: [
    ...
    {
      question:
        "What's a reasonable next step if my site fails Core Web Vitals on mobile but passes on desktop?",
      answer: [
    ...
    {
      question:
        "What's the single most useful first step for someone who's never checked their site against these thresholds?",
      answer: [
