...
export const meta: BlogPost = {
  ...
  description: "A source-backed breakdown of how ChatGPT search retrieves, evaluates, and cites pages, including why only a fraction of fetched pages ever get cited.",
  ...
  sections: [
    ...
    },
    {
      heading: "Comparisons",
      body: [
        [{ text: "ChatGPT search citations vs. Google organic rankings.", bold: true }, " Only ~12% URL overlap for matching queries, per Sellm's 400K-page analysis — these are functionally two different visibility games requiring separate optimization thinking, not one skill set applied twice."],
        [{ text: "ChatGPT search vs. Google AI Overviews, on source mix.", bold: true }, " ChatGPT's most-cited domain list is topped by Reddit (~16.7%) and Wikipedia (~8.9%) per Ahrefs; other industry research (Search Engine Land's coverage of BrightEdge findings, referenced in the companion topic on Wikipedia/Reddit citation dominance) documents that Google AI Overviews groups Reddit alongside other social platforms differently than ChatGPT does — the two systems weight the same source types differently even when both lean on community content."],
        [{ text: "Backlinks vs. content-answer fit as ranking signals.", bold: true }, " Traditional SEO treats backlink authority as a primary signal; Sellm's analysis of ChatGPT citations found backlinks correlate but explain limited variance, while answer-first extractable structure and precise content-answer fit are reported as stronger predictors in this specific context."],
      ],
    },
    {
      heading: "Real-world use cases",
      body: [
        ["– ", { text: "A B2B SaaS company", bold: true }, " restructures its comparison and pricing pages to lead with a direct, numeric answer in the first two paragraphs specifically to improve odds of being the extracted passage ChatGPT cites when someone asks a comparison question about that category."],
        ["– ", { text: "A publisher noticing declining ChatGPT citations", bold: true }, " audits whether its articles still open with narrative/scene-setting paragraphs before the actual answer, a pattern several GEO guides flag as a citation-suppressing structure given the reported concentration of citations in a page's first 30%."],
        ["– ", { text: "A brand with no Wikipedia presence", bold: true }, " recognizes, per Ahrefs' finding that Wikipedia pages alone account for nearly 30% of ChatGPT's top cited pages, that part of its AI-citation strategy has to include getting a properly sourced Wikipedia entry rather than relying solely on owned content."],
        ["– ", { text: "An SEO team", bold: true }, " stops assuming their page-one Google rankings will translate to ChatGPT citations, given the measured 12% overlap, and begins tracking ChatGPT citation appearances as a separate, parallel metric rather than a byproduct of traditional rank tracking."],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        ["Because ChatGPT citation performance doesn't track with Google rankings, it's worth checking directly with the ", { text: "AI Visibility Checker", href: "/geo/ai-visibility-checker" }, " whether your pages are actually surfacing in AI-generated answers rather than assuming your SEO rank is a reliable proxy."],
  ...
  faq: [
    {
      ...
      answer: ["A feature that lets ChatGPT fetch and cite current information from the web when a query needs it, rather than answering purely from training data (help.openai.com/en/articles/9237897-chatgpt-search)."],
    },
    {
      question: "Does ChatGPT rank pages the same way Google does?",
      answer: ["No — an analysis found only about 12% overlap between URLs cited by ChatGPT and Google's first-page results for the same queries (sellm.io/post/chatgpt-ranking-factors)."],
    },
    {
      question: "What search engine's index does ChatGPT search rely on?",
      answer: ["Analyses report ChatGPT primarily retrieves candidate pages through Bing's index during browsing (sellm.io/post/chatgpt-ranking-factors; ziptie.dev/blog/how-does-chatgpt-choose-its-sources/)."],
    },
    {
      question: "Can I see which sources ChatGPT used for an answer?",
      answer: ["Yes — OpenAI's help documentation confirms responses using web search can show selectable citations and a \"Sources\" view (help.openai.com/en/articles/9237897-chatgpt-search)."],
    },
    {
      question: "Is ChatGPT search available without an account?",
      answer: ["Yes, per OpenAI's help center, people who aren't signed in can also use the web search feature."],
    },
    {
      question: "How many citations does a typical ChatGPT search answer show?",
      answer: ["Typically 3 to 6 clickable citations per response when browse mode fires, per ZipTie's analysis."],
    },
    {
      question: "What triggers ChatGPT to search the web instead of answering from memory?",
      answer: ["Queries needing current information, explicit requests for sources, or topics outside the model's confident training-data range (help.openai.com/en/articles/9237897-chatgpt-search; ziptie.dev/blog/how-does-chatgpt-choose-its-sources/)."],
    },
    {
      question: "Why does ChatGPT cite Reddit so often?",
      answer: ["Reddit tops ChatGPT's most-cited domains at roughly 16.7% mention share for US queries, likely because it offers direct, plain-language answers the model can use to ground a specific claim (ahrefs.com/blog/most-cited-domains-in-chatgpt/)."],
    },
    {
      question: "Why does ChatGPT cite Wikipedia so often?",
      answer: ["Wikipedia sits around 8.9% mention share and, separately, accounts for nearly 30% of ChatGPT's top 1,000 cited pages, reflecting its role as a broad, sourced reference layer (ahrefs.com/blog/most-cited-domains-in-chatgpt/)."],
    },
    {
      question: "Does my content need to directly answer the question to get cited?",
      answer: ["Yes — citation selection is reported to hinge on whether a specific page passage directly supports a specific claim in the answer, not general topical relevance."],
    },
    {
      question: "What is Reciprocal Rank Fusion (RRF) in this context?",
      answer: ["A method for merging results across multiple reformulated versions of a query, rewarding pages that appear consistently across those reformulations rather than pages that only match one exact phrasing (sellm.io/post/chatgpt-ranking-factors)."],
    },
    {
      question: "What percentage of pages ChatGPT fetches actually get cited?",
      answer: ["Roughly 15%, meaning about 85% of fetched pages are evaluated and rejected before the final answer is written (airops.com/blog/chatgpt-decides-sources-cite; ziptie.dev/blog/how-does-chatgpt-choose-its-sources/)."],
    },
    {
      question: "Do backlinks still matter for ChatGPT citations?",
      answer: ["They still correlate with citation likelihood but explain only limited variance; content-answer fit and answer-first structure are reported as stronger predictors (sellm.io/post/chatgpt-ranking-factors)."],
    },
    {
      question: "Does schema markup increase citation odds?",
      answer: ["It's present on a majority (a reported 61%) of content ChatGPT cites — a correlation, not a confirmed causal factor (pravinkumar.co/blog/why-chatgpt-cites-reddit-not-my-website-2026)."],
    },
    {
      question: "Does heading structure (H1/H2/H3) matter for citations?",
      answer: ["Industry analysis reports 68.7% of ChatGPT-cited pages use a clean heading hierarchy, suggesting structural clarity correlates with citation likelihood."],
    },
    {
      question: "Does brand mention volume across the web matter more than backlinks?",
      answer: ["Ahrefs reports brand web-mention volume correlating with AI citation rates at about 0.664, roughly three times the correlation strength reported for backlinks (0.218)."],
    },
    {
      question: "What share of ChatGPT's top cited pages are Wikipedia, brand homepages, or app listings?",
      answer: ["Ahrefs' analysis of the top 1,000 cited pages found a combined 67% across those three categories (29.7% Wikipedia, 23.8% brand homepages, 6.6% app store listings)."],
    },
    {
      question: "Does the freshness of content matter for ChatGPT citations?",
      answer: ["Industry research cited in broader GEO analysis reports that a very large share of ChatGPT citations come from recently published content, underscoring that stale, unupdated pages are disadvantaged relative to freshly published or updated ones."],
    },
    {
      question: "Is GEO the same thing as SEO?",
      answer: ["No — Generative Engine Optimization (GEO) refers specifically to structuring content so AI systems select it as a cited source, a related but distinct discipline from optimizing for traditional search rankings."],
    },
    {
      question: "Can a page rank poorly on Google but still get cited often by ChatGPT?",
      answer: ["Yes — given the roughly 12% overlap between the two, a page's ChatGPT citation performance is not reliably predicted by its Google ranking in either direction."],
    },
    {
      question: "How do I check whether ChatGPT is citing my site?",
      answer: ["Ask ChatGPT search-triggering questions relevant to your content directly and review the Sources view, or use a dedicated AI-visibility tracking tool that monitors citation appearances over time."],
    },
    {
      question: "How do I structure a page to increase ChatGPT citation odds?",
      answer: ["Lead with a direct, specific answer in the first 30% of the page, use question-format H2 headings each followed by a short self-contained answer, and maintain a clean heading hierarchy throughout."],
    },
    {
      question: "How do I get cited for comparison-style questions specifically?",
      answer: ["Include the concrete numbers or facts being compared directly and early in the page rather than after extended narrative, since extractable factual passages are what the citation-selection stage looks for."],
    },
    {
      question: "How do I increase my odds of being cited alongside Wikipedia?",
      answer: ["Recognize Wikipedia occupies a large, separate citation category; pursue a properly sourced Wikipedia entry as a complementary channel rather than trying to out-rank Wikipedia with owned content alone."],
    },
    {
      question: "How do I make my robots.txt compatible with getting cited by ChatGPT search?",
      answer: ["Allow OAI-SearchBot in robots.txt, since it is the crawler indexing content for ChatGPT's search feature, separate from GPTBot's training-only crawl."],
    },
    {
      question: "How do I write content that survives ChatGPT's internal query reformulation?",
      answer: ["Cover the topic's common related phrasings comprehensively on one page instead of writing narrowly for a single exact keyword string."],
    },
    {
      question: "How do I know if my content is being fetched but not cited?",
      answer: ["There's no direct diagnostic from OpenAI for this; the practical proxy is auditing whether your content has a clear, directly-answering passage near the top, since that's the reported differentiator between fetched-and-cited versus fetched-and-discarded content."],
    },
    {
      question: "How long does it take to see a citation improvement after restructuring content?",
      answer: ["Industry GEO guidance reports structural optimizations typically showing a citation lift within 30 to 60 days, while broader authority-signal improvements take 3 to 6 months."],
    },
    {
      question: "Why doesn't ChatGPT cite my website even though it ranks well on Google?",
      answer: ["Because the two systems select sources through largely separate mechanisms, with only about 12% URL overlap; strong Google rank doesn't transfer."],
    },
    {
      question: "Why did my ChatGPT citations drop recently?",
      answer: ["Possible causes include content going stale relative to fresher competing pages, changes to answer-first structure, or shifts in which platforms ChatGPT is weighting for a given query type — none of which are directly diagnosable without a tracking tool, but auditing content freshness and structure is the first step."],
    },
    {
      question: "Is Reciprocal Rank Fusion an OpenAI-confirmed mechanism or a researcher inference?",
      answer: ["It's presented in the cited analysis (sellm.io) as an inferred/observed mechanism based on citation-pattern data, not something OpenAI has officially confirmed as its exact ranking method."],
    },
    {
      question: "Does ChatGPT weight recency of a page differently than Google does?",
      answer: ["Direct comparative data wasn't available in this research; evidence not sufficiently verified beyond the general finding that ChatGPT favors recently published content in its citations."],
    },
    {
      question: "Can paid promotion or ads influence ChatGPT citation selection?",
      answer: ["Evidence not sufficiently verified — none of the reviewed sources document a paid mechanism for influencing ChatGPT's organic citation selection."],
    },
    {
      question: "Does ChatGPT's citation behavior vary by query language or country?",
      answer: ["Evidence not sufficiently verified in this research; the cited domain-share statistics reviewed are specific to US queries, and behavior may differ elsewhere."],
    },
    {
      question: "ChatGPT search vs. Google AI Overviews — do they cite the same top domains?",
      answer: ["Not identically — both lean on community/reference content, but independent research on citation patterns documents different weighting (e.g., how each treats Reddit and social platforms), meaning the two require somewhat separate optimization thinking."],
    },
    {
      question: "ChatGPT search vs. Bing search citations — how do they compare?",
      answer: ["Since ChatGPT's browsing retrieval leans on Bing's index, the two share an underlying retrieval layer, but ChatGPT applies its own additional passage-extraction and citation-selection filter on top, meaning results can diverge even when pulling from the same base index."],
    },
    {
      question: "Backlinks vs. brand mentions — which correlates more strongly with ChatGPT citations?",
      answer: ["Ahrefs reports brand mentions correlating roughly three times as strongly (about 0.664 vs. 0.218 for backlinks) in its analysis."],
    },
    {
      question: "Answer-first structure vs. long-form narrative content — which performs better for citations?",
      answer: ["Answer-first structure is reported as a stronger predictor, with roughly 44% of citations reportedly coming from a page's first 30% of content."],
    },
    {
      question: "Is a well-optimized brand homepage or a blog article more likely to get cited?",
      answer: ["Both appear in ChatGPT's citation mix, but Ahrefs' analysis found brand homepages alone account for nearly a quarter of the top 1,000 cited pages, suggesting a clear, authoritative homepage carries real citation weight of its own."],
    },
    {
      question: "Community platforms (Reddit) vs. reference sites (Wikipedia) — which does ChatGPT favor more?",
      answer: ["Reddit edges out Wikipedia in overall mention share (~16.7% vs ~8.9%) per Ahrefs, though both significantly outpace most individual brand or business sites."],
    },
    {
      question: "My content answers the question but still isn't cited — what's likely wrong?",
      answer: ["Check whether the answer is buried past the first 30% of the page, whether the passage is precise and self-contained enough to extract cleanly, and whether a competing source (often Reddit or Wikipedia) already covers the same claim more directly."],
    },
    {
      question: "My ChatGPT citations dropped after a site redesign — what should I check first?",
      answer: ["Verify the new template didn't push the direct answer further down the page, didn't break heading hierarchy, and that OAI-SearchBot/GPTBot access wasn't accidentally blocked in the new robots.txt."],
    },
    {
      question: "ChatGPT keeps citing my competitor's older, less accurate page instead of my updated one — why?",
      answer: ["Possible reasons include the competitor's page having a more directly extractable answer passage, stronger brand mention volume across the web, or simply having been indexed and established longer; content quality alone doesn't guarantee citation preference over these structural and authority factors."],
    },
    {
      question: "My page ranks on Google's first page but never appears in ChatGPT — is something broken?",
      answer: ["Not necessarily broken — given the measured ~12% overlap between the two systems, this is a common and expected outcome, not evidence of a technical error."],
    },
    {
      question: "I fixed my content structure but still see no ChatGPT citations — how long should I wait?",
      answer: ["Structural fixes are reported to show citation lift within 30 to 60 days in industry guidance; if nothing changes well beyond that window, revisit whether OAI-SearchBot access, content freshness, or topical competition (e.g., strong existing Reddit/Wikipedia coverage) is the blocker."],
    },
    {
      question: "Is it worth hiring a GEO/AI-visibility consultant instead of doing this myself?",
      answer: ["For teams without bandwidth to continuously monitor citation patterns and restructure content iteratively, a specialist consultant or agency can shortcut the trial-and-error, particularly for auditing the more technical layers (robots.txt, Bing indexability, schema)."],
    },
    {
      question: "Is investing in a Wikipedia presence worth it given Wikipedia's large citation share?",
      answer: ["Given Wikipedia's roughly 30% share of ChatGPT's top cited pages, a properly sourced, policy-compliant Wikipedia entry is a reasonable complementary investment for brands with genuine notability, though it must meet Wikipedia's own sourcing and notability standards rather than being treated as a marketing placement."],
    },
    {
      question: "Should a small business prioritize ChatGPT citation visibility or traditional SEO first?",
      answer: ["Given the low overlap between the two systems, most businesses need both as separate workstreams rather than treating one as a substitute for the other, with prioritization depending on where the business's target customers actually search."],
    },
    {
      question: "How do I monitor ChatGPT citation performance over time without manually querying it constantly?",
      answer: ["A dedicated AI-visibility tracking tool is the practical option, since OpenAI doesn't provide a native analytics dashboard for third-party site owners to see their own citation frequency."],
    },
    {
      question: "What's the single highest-leverage change to make first if I've never optimized for ChatGPT citations?",
      answer: ["Restructure your page's opening so the direct, specific answer to its core question appears within the first 30% of content, since that single change touches the factor most consistently reported as citation-predictive across the reviewed sources."],
    },
  ],
  sources: [
