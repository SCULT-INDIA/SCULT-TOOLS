...
export const meta: BlogPost = {
  ...
  description:
    'Real numbers on AI agent costs in production — token multipliers, prompt caching savings, hidden infrastructure spend, and how bills spiral overnight.',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        [
          {
            text: 'Example 1 — A support team scoping a first agent deployment.',
            bold: true,
          },
          ' Based on the ranges above, a team automating a moderate volume of tier-1 support tickets should budget for something closer to the $1,000–$5,000/month mid-size range, not the $200/month lightweight-assistant figure, since customer support workloads tend to involve longer conversational context and more tool calls per resolution than a narrow coding assistant.',
        ],
        [
          {
            text: 'Example 2 — A team seeing a cost spike after a feature launch.',
            bold: true,
          },
          ' If a newly launched agent feature shows a sudden multi-x cost jump within days, the healthcare-company RAG-retry pattern above is a useful diagnostic starting point: check for retrieval failures or tool-call loops before assuming the spike is simply proportional to new user volume.',
        ],
        [
          {
            text: 'Example 3 — A team choosing between one frontier model for everything vs. tiered routing.',
            bold: true,
          },
          ' Based on the ~8x blended-cost gap cited above ($2.31 vs $18.40 per million tokens), a team processing a high volume of straightforward requests alongside a smaller number of genuinely complex ones has a clear, quantifiable case for implementing model routing rather than defaulting every call to the most capable (and most expensive) model.',
        ],
        [
    ...
    },
    {
      ...
      body: [
        [
          '– Agentic workflows use 5–30x more tokens per task than chatbot queries; re-sent context drives most of the bill: ',
          {
            text: 'Cockroach Labs',
        ...
        [
          '– Monthly cost range $200 (lightweight) to $5,000+ (high-volume support agent): ',
          {
            text: 'Kanopy Labs',
            href: 'https://kanopylabs.com/blog/how-much-do-ai-agents-cost-to-run-monthly',
            external: true,
          },
          '.',
        ],
        ...
        [
          '– Industry model API spend roughly doubled ~$3.5B to ~$8.4B, late 2024 to mid-2025: cited via ',
          {
            text: 'gettiaconsulting.com',
            href: 'https://www.gettiaconsulting.com/en/actualites/cout-reel-agent-ia-2026-decomposition-cas-concret',
            external: true,
          },
          ' and ',
          {
            text: 'riseuplabs.com',
            href: 'https://riseuplabs.com/ai-agent-development-cost/',
            external: true,
          },
          '.',
        ],
        [
          '– $400 overnight incident from a 47x tool-call loop: ',
          {
            text: 'dev.to (hidai25)',
        ...
        [
          '– Up to 90% of always-on backend cost can go to idle time given bursty agent usage patterns: ',
          {
            text: 'dev.to (hamza4600)',
            href: 'https://dev.to/hamza4600/the-hidden-costs-of-ai-agents-what-no-ones-telling-you-51d4',
            external: true,
          },
          '.',
        ],
        [
          '– Per-task cost $0.03–$2.60 for coding agents; $0.001 for simple chatbot interactions; $5–8 for complex reasoning-model tasks: corroborated by ',
          {
            text: 'Codebridge',
            href: 'https://www.codebridge.tech/articles/ai-agent-development-cost-real-cost-per-successful-task',
            external: true,
          },
          ' and ',
          {
            text: 'Neontri',
            href: 'https://neontri.com/blog/ai-agent-development-cost/',
            external: true,
          },
          '.',
        ],
    ...
    },
    {
      ...
      body: [
        [
          { text: 'AI agent cost vs. chatbot cost.', bold: true },
          ' A single chatbot turn processes one request and returns one response; an agent task involves multiple reasoning-and-tool-call cycles, each re-sending accumulated context — which is the direct mechanical reason agents cost 5-30x more per task than a comparable chatbot interaction.',
        ],
        [
          { text: 'Inference cost vs. orchestration cost.', bold: true },
          ' Inference (the LLM API bill itself) is the smaller of the two, at roughly 20% of total cost; orchestration, monitoring, and governance infrastructure make up the larger, less visible 80% — a distinction that matters because teams that only budget for the API bill are budgeting for the smaller quarter of their actual cost.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'No circuit breaker on tool-call loops.', bold: true },
          ' The $400-overnight incident happened specifically because nothing was watching for repeated identical tool calls and stopping them.',
        ],
        [
          '– ',
          { text: 'Treating token volume as a productivity signal.', bold: true },
          ' Discussed in the context of enterprise agent rollouts, where high usage got implicitly rewarded rather than measured against actual value delivered.',
        ],
        [
          '– ',
          {
            text: 'Running every task through the most capable (most expensive) model.',
            bold: true,
          },
          ' The ~8x blended-cost gap between tiered routing and frontier-only routing is a direct, quantified cost of skipping model-tiering.',
        ],
        [
          '– ',
          {
            text: 'Deploying always-on infrastructure for bursty workloads.',
            bold: true,
          },
          ' Up to 90% of backend cost can go to idle time when agent usage is inherently bursty but infrastructure runs 24/7 regardless.',
        ],
        [
          '– ',
          { text: 'Letting sessions run indefinitely instead of resetting.', bold: true },
          ' Context rot after ~20-30 turns drives both worse answers and higher cost from the retries those worse answers cause.',
        ],
        [
          '– ',
          { text: 'Budgeting for inference only.', bold: true },
          ' Missing the ~80% of total cost that comes from orchestration, monitoring, and governance infrastructure.',
        ],
        [
          '– ',
          { text: 'No retrieval-failure monitoring in RAG-based agents.', bold: true },
          " The healthcare company's 6-week, $12,000→$68,000 spike traced directly to unmonitored retrieval faults causing repeated retries.",
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          'For teams thinking through prompt design and orchestration patterns before committing to a production agent architecture, the ',
          { text: 'AI Agents & RAG', href: '/prompts/ai-engineering' },
          ' and ',
          { text: 'DevOps & Cloud', href: '/prompts/devops' },
          ' prompt collections cover related groundwork — from RAG chunking strategy to deployment planning — that feeds directly into the cost decisions this article walks through.',
        ],
        [
          "If you're past the planning stage and weighing whether to build a production-grade agent in-house versus getting help avoiding the cost pitfalls documented here — circuit breakers, model routing, retrieval monitoring, and the orchestration layer that makes up most of the real bill — that's exactly the kind of build ",
          {
  ...
  faq: [
    {
      ...
      answer: [
        'Estimates range from about $200/month for a lightweight assistant to $5,000+/month for a high-volume support agent, with mid-size custom agents commonly landing $1,000–$5,000/month including infrastructure. (',
        {
          text: 'Kanopy Labs',
          href: 'https://kanopylabs.com/blog/how-much-do-ai-agents-cost-to-run-monthly',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Agents run multi-step tool-call loops that re-send accumulated context on every turn, consuming roughly 5-30x more tokens per task than a single chatbot query. (',
        {
          text: 'Cockroach Labs',
          href: 'https://www.cockroachlabs.com/blog/agentic-ai-costs-at-scale/',
          external: true,
    ...
    {
      question:
        'How much of AI agent spend is actually recoverable through optimization?',
      answer: [
    ...
    {
      question:
        'Advanced: how do you architect an agent to minimize re-sent context cost?',
      answer: [
    ...
    {
      question:
        'Advanced: how should a team calculate break-even on implementing prompt caching?',
      answer: [
    ...
    {
      question:
        'Advanced: is there a formula for estimating total cost of ownership beyond the API bill?',
      answer: [
    ...
    {
      question:
        'Advanced: how do you decide the right model-routing threshold for cost vs. quality?',
      answer: [
    ...
    {
      question:
        'Serverless vs. always-on infrastructure for agent deployment — which is cheaper?',
      answer: [
    ...
    {
      question:
        'Frontier-model-only routing vs. tiered model routing — how big is the cost gap?',
      answer: [
    ...
    {
      question:
        'Single long session vs. periodically reset sessions — which is more cost-efficient?',
      answer: [
    ...
    {
      question:
        "My AI agent's cost per task seems way higher than industry estimates — what should I check first?",
      answer: [
    ...
    {
      question:
        "My RAG-based agent's cost jumped sharply after a data source change — why?",
      answer: [
    ...
    {
      question:
        "My team can't explain where our AI agent budget actually went — what's missing?",
      answer: [
    ...
    {
      question:
        'Our agent works fine on small inputs but gets expensive and less accurate on large ones — why?',
      answer: [
    ...
    {
      question:
        'We adopted an agentic coding tool org-wide and costs are climbing fast — what should we do?',
      answer: [
    ...
    {
      question:
        'Is it worth building a custom AI agent, or should we use an off-the-shelf platform for cost reasons?',
      answer: [
    ...
    {
      question:
        'Is it worth investing in model routing infrastructure for a small-scale agent deployment?',
      answer: [
    ...
    {
      question:
        'Should we prioritize prompt caching or model routing first if we can only implement one?',
      answer: [
    ...
    {
      question:
        'Should cost per task or cost per outcome be the metric leadership actually cares about?',
      answer: [
    ...
    {
      question:
        'How do I build a cost case for adding circuit breakers and monitoring before a leadership review?',
      answer: [
    ...
    {
      question:
        'Is it worth negotiating volume discounts with a model provider before or after production launch?',
      answer: [
    ...
    {
      question:
        'Should a small team buy a third-party agent cost-monitoring tool or build tracking in-house?',
      answer: [
    ...
    {
      question:
        'What questions should go into an RFP or vendor evaluation for an agent orchestration platform?',
      answer: [
    ...
    {
      question:
        'Is switching to a cheaper model provider a faster fix than implementing model routing?',
      answer: [
    ...
    {
      question:
        'How do I decide whether to cap agent spend with a hard budget limit or a soft alert?',
      answer: [
    ...
    {
      question:
        'Does moving from a single frontier model to a multi-model routing setup require a different vendor contract?',
      answer: [
    ...
    {
      question:
        "What's a reasonable way to phase AI agent cost controls if we can't implement everything at once?",
      answer: [
    ...
    {
      question:
        'How do we know if our AI agent program is actually cost-effective, not just cost-monitored?',
      answer: [
