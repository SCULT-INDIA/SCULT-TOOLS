...
export const meta: BlogPost = {
  ...
  description:
    "A huge advertised context window doesn't guarantee accurate long-document analysis. Here's what real testing shows about Claude, GPT, and Gemini on long documents.",
  ...
  sections: [
    {
      ...
      body: [
        ...
        [
          'One commenter frames the benchmark bluntly as testing "how lazy is my LLM being when it comes to analyzing the input I\'ve provided to it" — distinguishing surface-level retrieval from actually reading and reasoning over the material (',
          {
            text: 'HN: needle in haystack test LLM',
            href: 'https://hn.algolia.com/api/v1/search?query=needle%20in%20haystack%20test%20LLM',
            external: true,
          },
          '). Other commenters note models handle simple "needle" retrieval fairly well but "struggle with complex reasoning over lengthy contexts" — meaning a model can pass the standard version of this test and still fail at synthesizing or reasoning across a genuinely long document (',
          {
            text: 'HN: needle in haystack test LLM',
            href: 'https://hn.algolia.com/api/v1/search?query=needle%20in%20haystack%20test%20LLM',
            external: true,
          },
          '). This distinction matters enormously for anyone evaluating a model for contract review, research synthesis, or any task that needs actual understanding rather than fact lookup.',
        ],
      ],
    },
    {
      ...
      body: [
        ...
        [
          ...
          ' Claude 3 Opus was documented as showing sensitivity to *where* information is placed within a long input — a real, reported finding distinct from simply whether the information fits within the window at all (',
          {
            text: 'HN: needle in haystack test LLM',
            href: 'https://hn.algolia.com/api/v1/search?query=needle%20in%20haystack%20test%20LLM',
            external: true,
          },
          '). As of 2026, current Claude Opus, Sonnet, and Fable-line models carry a 1-million-token context window (Haiku 4.5 remains at 200K) (',
          {
            text: 'Fastio',
            href: 'https://fast.io/resources/claude-context-window-guide/',
            external: true,
          },
          ") — a substantial jump from the 200K ceiling that was standard through much of the model family's earlier history, and the window size within which the earlier positional-sensitivity finding was originally reported.",
        ],
        [
          { text: 'GPT.', bold: true },
          ' One real HN account claims GPT-5 offers a "reliable 400k window" for sustained coding/document sessions versus what the commenter describes as Claude\'s "200k hard limit" — though this is explicitly a single practitioner\'s account, not a controlled benchmark, and it predates Claude\'s move to a 1M-token window across its current model tier (',
          {
            text: 'HN: Claude vs GPT vs Gemini',
            href: 'https://hn.algolia.com/api/v1/search?query=Claude%20vs%20GPT%20vs%20Gemini',
            external: true,
          },
          '). A separate real report found GPT-4o outperforming a Gemini variant under the 128k-token range specifically (',
          {
            text: 'HN: Gemini 1M context window needle haystack',
            href: 'https://hn.algolia.com/api/v1/search?query=Gemini%201M%20context%20window%20needle%20haystack',
            external: true,
    ...
    },
    {
      ...
      body: [
        ...
        [
          ...
          '). Both are legitimate, task-dependent conclusions rather than contradictory claims about the same thing.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          {
            text: 'Real, documented example — the direct tokenizer comparison.',
            bold: true,
          },
          " A concrete, real comparison of Claude Sonnet 4.5 and Gemini's tokenizer efficiency on Tamil text (1.19 vs. 4.24 characters per token) is one of the few genuinely quantified, apples-to-apples comparisons available across providers in this space, and it's specific to non-English content rather than a general claim (",
          {
            text: 'HN: Claude vs GPT vs Gemini',
            href: 'https://hn.algolia.com/api/v1/search?query=Claude%20vs%20GPT%20vs%20Gemini',
            external: true,
        ...
        [
          {
            text: "Real, documented example — the 55,000-word guide that didn't fit.",
            bold: true,
          },
          ' One practitioner reported a 55,000-word guide being "too big for a context window" to get coherent answers from directly (well within most current providers\' advertised token maximums in raw capacity terms, but apparently not within the effective window for the task as attempted), leading them to condense it into a separate reference file rather than relying on the raw window (',
          {
            text: 'HN: context window marketing vs actual',
            href: 'https://hn.algolia.com/api/v1/search?query=context%20window%20marketing%20vs%20actual',
            external: true,
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: "Gemini's needle-in-haystack recall", bold: true },
          ': near-perfect from Gemini 1.5 onward, per real practitioner discussion (',
          {
            text: 'HN: needle in haystack test LLM',
            href: 'https://hn.algolia.com/api/v1/search?query=needle%20in%20haystack%20test%20LLM',
            external: true,
        ...
        [
          '– ',
          { text: "Gemini 2.0's real-world PDF handling", bold: true },
          ': reported as degrading significantly beyond roughly 20-40k tokens by one practitioner, despite a 1M-token advertised window (',
          {
            text: 'HN: Gemini 1M context window needle haystack',
            href: 'https://hn.algolia.com/api/v1/search?query=Gemini%201M%20context%20window%20needle%20haystack',
            external: true,
        ...
        [
          '– ',
          { text: "Gemini 2.5's long-context handling", bold: true },
          ': described by a different practitioner as a "breakthrough moment" versus older models that "get lost, hallucinate and are pretty much worthless" past 200k tokens (',
          {
            text: 'HN: Gemini 1M context window needle haystack',
            href: 'https://hn.algolia.com/api/v1/search?query=Gemini%201M%20context%20window%20needle%20haystack',
            external: true,
        ...
        [
          '– ',
          { text: "Claude 3 Opus's documented positional sensitivity", bold: true },
          ': real reported finding that performance varied depending on where information was placed within a long input (',
          {
            text: 'HN: needle in haystack test LLM',
            href: 'https://hn.algolia.com/api/v1/search?query=needle%20in%20haystack%20test%20LLM',
            external: true,
        ...
        [
          '– ',
          { text: 'Current (2026) context windows', bold: true },
          ': Claude Opus/Sonnet/Fable-line at 1M tokens (Haiku 4.5 at 200K) (',
          {
            text: 'Fastio',
            href: 'https://fast.io/resources/claude-context-window-guide/',
            external: true,
          ...
          '); Gemini 3 Pro at 1M by default, Gemini 1.5 Pro upgradeable to 2M in some workflows (',
          {
            text: 'AI-Toolbox',
            href: 'https://www.ai-toolbox.co/gemini-models/gemini-context-window-token-limits-2026',
            external: true,
        ...
        [
          '– ',
          { text: 'Tokenizer efficiency for Tamil text', bold: true },
          ': Claude Sonnet 4.5 at 1.19 characters/token vs. Gemini at 4.24 characters/token — roughly a 3.5x cost/length difference for equivalent non-English content (',
          {
            text: 'HN: Claude vs GPT vs Gemini',
            href: 'https://hn.algolia.com/api/v1/search?query=Claude%20vs%20GPT%20vs%20Gemini',
            external: true,
        ...
        [
          '– ',
          {
            text: 'Practitioner model preferences for day-to-day summarization',
            bold: true,
          },
          ': Gemini and ChatGPT mentioned as "fairly well behaved," with budget alternatives (Llama 4, Qwen, GLM) described as "okay/not bad" but not top-tier — reflecting that choice is often driven by budget as much as raw capability (',
          {
            text: 'HN: which AI model is best for summarizing',
            href: 'https://hn.algolia.com/api/v1/search?query=which%20AI%20model%20is%20best%20for%20summarizing',
            external: true,
          },
          ').',
        ],
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Contract and legal document review', bold: true },
          ', where the retrieval-vs-comprehension distinction matters directly: finding a specific clause is a different (and generally easier) task than identifying inconsistencies or implications across an entire contract.',
        ],
        [
          '– ',
          { text: 'Research synthesis', bold: true },
          ', where a model needs to accurately represent relationships and arguments across a long document or set of documents, not just retrieve isolated facts.',
        ],
        [
          '– ',
          { text: 'RAG pipeline design decisions', bold: true },
          ", where teams building document-heavy applications choose between full-context inclusion and retrieval-based chunking based on their specific task's comprehension requirements, as the real, split practitioner accounts above illustrate.",
        ],
        [
          '– ',
          { text: 'Multilingual document processing', bold: true },
          ', where the documented tokenizer-efficiency difference between providers has a direct, measurable cost and effective-length impact distinct from the context-window-size comparison alone.',
        ],
      ],
    },
    {
      ...
      body: [
        [
          '– ',
          {
            text: 'Choosing a provider based on advertised context-window size alone',
            bold: true,
          },
          ', when real-world reports consistently show effective performance diverging from the advertised ceiling, sometimes dramatically.',
        ],
        [
          '– ',
          {
            text: 'Treating needle-in-haystack test results as proof of genuine document comprehension',
            bold: true,
          },
          ', when practitioners explicitly describe the test as measuring surface-level retrieval rather than deep reasoning.',
        ],
        [
          '– ',
          { text: 'Ignoring tokenizer efficiency for non-English content', bold: true },
          ", missing a real, measurable cost and effective-length difference between providers that a raw token-count comparison doesn't capture.",
        ],
        [
          '– ',
          {
            text: "Assuming a single practitioner's account generalizes to your specific task and document type",
            bold: true,
          },
          ', when the sources reviewed here show genuinely conflicting real reports (e.g., "hopeless" vs. "breakthrough" descriptions of similar Gemini capability at different versions).',
        ],
        [
          '– ',
          {
            text: 'Defaulting to full-context inclusion for every task without testing RAG as an alternative',
            bold: true,
          },
          ', or vice versa — the right choice is genuinely task-dependent per real practitioner accounts on both sides.',
        ],
        [
          '– ',
          {
            text: 'Not testing with your actual document type and task before committing to a provider',
            bold: true,
          },
          ', relying instead on generic benchmark claims that may not predict your specific comprehension-task performance.',
        ],
      ],
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Test your actual task type, not just retrieval', bold: true },
          ", since needle-in-haystack performance doesn't reliably predict comprehension-task performance for contract review, research synthesis, or similar work.",
        ],
        [
          '– ',
          { text: 'Benchmark at your realistic document length', bold: true },
          ', not at the advertised maximum — real degradation has been reported well before advertised ceilings across multiple providers and versions.',
        ],
        [
          '– ',
          {
            text: 'Factor in tokenizer efficiency for non-English content specifically',
            bold: true,
          },
          ', since a documented 3.5x cost/length difference between providers on the same text is a real, measurable factor a raw window-size comparison misses.',
        ],
        [
          '– ',
          { text: 'Re-test when providers release new model versions', bold: true },
          ', since real accounts show meaningful version-to-version differences (e.g., Gemini 2.0 vs. 2.5) in long-context handling quality.',
        ],
        [
          '– ',
          {
            text: 'Choose full-context inclusion vs. RAG based on your specific task',
            bold: true,
          },
          ', not on a general belief that either approach is universally superior — real practitioner evidence supports both, depending on the workload.',
        ],
        [
          '– ',
          {
            text: 'Treat single practitioner accounts as real but not generalizable evidence',
            bold: true,
          },
          ', especially where sources genuinely conflict — run your own test on your actual documents before committing to a provider for a production system.',
        ],
        [
          '– ',
          { text: 'Separate "does it fit" from "does it work"', bold: true },
          ' when evaluating a provider — a document fitting within the advertised context window is necessary but not sufficient for accurate analysis.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          "For prompt patterns specific to each provider's strengths and quirks when working with long documents, see the ",
          { text: 'Claude', href: '/prompts/claude' },
          ', ',
          { text: 'ChatGPT', href: '/prompts/chatgpt' },
          ', and ',
          { text: 'Gemini', href: '/prompts/gemini' },
          ' prompt libraries on tools.scult.in.',
        ],
        [
          "If you're building a document-heavy product — contract review, research synthesis, or a RAG pipeline — and need to actually test and choose between providers rather than guess from marketing specs, that's exactly the kind of architecture decision worth a conversation with SCULT.IN about ",
          {
            text: 'AI agents & automation',
            href: SERVICE_AI_CONSULTING.href,
            external: true,
          },
          ' for help designing and benchmarking a document-analysis pipeline against your real data before committing to a provider.',
        ],
      ],
    },
  ],
  faq: [
    ...
    {
      question:
        'Does Gemini actually read the whole document, or just retrieve facts from it?',
      answer: [
        'Real accounts are split — Gemini shows near-perfect needle-in-haystack fact retrieval from version 1.5 onward, but genuine comprehension quality on real documents has been reported as ranging from "hopeless" (Gemini 2.0, past 20-40k tokens in one account) to a "breakthrough" (Gemini 2.5, in another account) (',
        {
          text: 'HN: Gemini 1M context window needle haystack',
          href: 'https://hn.algolia.com/api/v1/search?query=Gemini%201M%20context%20window%20needle%20haystack',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Claude 3 Opus specifically was documented as sensitive to where information is placed within a long input — a positional effect distinct from simply whether the information technically fits in the context window (',
        {
          text: 'HN: needle in haystack test LLM',
          href: 'https://hn.algolia.com/api/v1/search?query=needle%20in%20haystack%20test%20LLM',
          external: true,
    ...
    },
    {
      ...
      answer: [
        "A benchmark that hides a specific fact within a very long input and tests whether a model can retrieve it accurately regardless of where it's placed — a real, widely used test, but one that measures retrieval, not necessarily deep comprehension (",
        {
          text: 'HN: needle in haystack test LLM',
          href: 'https://hn.algolia.com/api/v1/search?query=needle%20in%20haystack%20test%20LLM',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Current Opus, Sonnet, and Fable-line models carry a 1-million-token context window; Haiku 4.5 remains at 200K (',
        {
          text: 'Fastio',
          href: 'https://fast.io/resources/claude-context-window-guide/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'The base GPT-5 API supports 400,000 tokens; newer GPT-5.4/5.5 variants reach 1 million-plus tokens (',
        {
          text: 'Rohan Paul / X',
          href: 'https://x.com/rohanpaul_ai/status/1953549303638557183',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Gemini 3 Pro defaults to 1 million tokens, with Gemini 1.5 Pro remaining available in some workflows at an upgradeable 2-million-token ceiling (',
        {
          text: 'AI-Toolbox',
          href: 'https://www.ai-toolbox.co/gemini-models/gemini-context-window-token-limits-2026',
          external: true,
    ...
    {
      question:
        'Claude vs. GPT-4 vs. Gemini — which had the largest context window historically?',
      answer: [
    ...
    },
    {
      ...
      answer: [
        "It's genuinely task-dependent — real accounts show full-context inclusion outperforming RAG for architectural/holistic understanding tasks in some cases, while GraphRAG was built specifically to address remaining context-limit bottlenecks in others (",
        {
          text: 'HN: context window marketing vs actual',
          href: 'https://hn.algolia.com/api/v1/search?query=context%20window%20marketing%20vs%20actual',
          external: true,
    ...
    {
      question:
        'Does the language of a document change the effective cost across models?',
      answer: [
        "Yes — a real tokenizer comparison found Claude Sonnet 4.5 encoding Tamil at 1.19 characters/token versus Gemini's 4.24 characters/token, a roughly 3.5x cost difference for equivalent non-English content (",
        {
          text: 'HN: Claude vs GPT vs Gemini',
          href: 'https://hn.algolia.com/api/v1/search?query=Claude%20vs%20GPT%20vs%20Gemini',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'A commenter frames the needle-in-haystack benchmark itself as testing "how lazy is my LLM being" — highlighting that models can retrieve isolated facts without necessarily engaging deeply with the surrounding material (',
        {
          text: 'HN: needle in haystack test LLM',
          href: 'https://hn.algolia.com/api/v1/search?query=needle%20in%20haystack%20test%20LLM',
          external: true,
    ...
    {
      question:
        'What\'s the difference between a model\'s "physical" and "effective" context window?',
      answer: [
    ...
    {
      question:
        'Do models struggle more with simple retrieval or complex reasoning over long documents?',
      answer: [
        'Complex reasoning — practitioners note models handle simple "needle" retrieval fairly well but "struggle with complex reasoning over lengthy contexts," meaning the benchmark reveals only surface-level capability (',
        {
          text: 'HN: needle in haystack test LLM',
          href: 'https://hn.algolia.com/api/v1/search?query=needle%20in%20haystack%20test%20LLM',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Real reports describe sessions reaching roughly 350,000 tokens in agentic coding work, with at least one practitioner arguing a 200K-token cap "really isn\'t a sophisticated enough model" for that kind of sustained workload — though this specific account concerns coding sessions, not pure document analysis (',
        {
    ...
    {
      question:
        'How do I test which model is best for my specific document-analysis use case?',
      answer: [
    ...
    {
      question:
        'How do I know if a model is really reading my whole document or just skimming it?',
      answer: [
    ...
    {
      question:
        'How do I decide between full-context inclusion and RAG for my document pipeline?',
      answer: [
    ...
    {
      question:
        'How do I benchmark long-document performance without relying on marketing claims?',
      answer: [
    ...
    {
      question:
        'How do I check for positional sensitivity issues like the one documented in Claude 3 Opus?',
      answer: [
    ...
    {
      question:
        'How do I build a contract-review pipeline that avoids the retrieval-vs-comprehension trap?',
      answer: [
    ...
    {
      question:
        'How do I choose a model for research synthesis across multiple long documents?',
      answer: [
    ...
    {
      question:
        'Does model performance on document analysis correlate with general benchmark scores?',
      answer: [
    ...
    {
      question:
        'Is there a meaningful difference between chat-interface and API context limits for document analysis?',
      answer: [
    ...
    {
      question:
        'Can a model pass a needle-in-haystack test and still fail at real document analysis?',
      answer: [
    ...
    {
      question:
        'Claude vs. GPT vs. Gemini — which is cheapest for long-document processing?',
      answer: [
    ...
    {
      question:
        'GPT vs. Claude — which has been more consistent across versions on long-context accuracy?',
      answer: [
    ...
    {
      question:
        'RAG vs. GraphRAG vs. full-context inclusion — which should I use for long-document analysis?',
      answer: [
    ...
    {
      question:
        'Needle-in-haystack benchmarks vs. real-world document testing — which should I trust more?',
      answer: [
    ...
    {
      question:
        "My model retrieves facts correctly but gives shallow summaries of my long document — what's happening?",
      answer: [
    ...
    {
      question:
        'My document is well under the advertised context limit but the model still seems to miss things — why?',
      answer: [
    ...
    {
      question:
        'My non-English document processing is costing much more than expected — why?',
      answer: [
    ...
    {
      question:
        'I switched providers and got noticeably different long-document results — is that expected?',
      answer: [
    ...
    {
      question:
        'My RAG pipeline seems redundant now that my model has a 1M-token window — should I remove it?',
      answer: [
    ...
    {
      question:
        'Is it worth paying for the largest available context window for my document-analysis product?',
      answer: [
    ...
    {
      question:
        'Should I build a document-analysis product around a single provider, or design for provider flexibility?',
      answer: [
