...
export const meta: BlogPost = {
  ...
  description:
    'A practical, evidence-based walkthrough of how first-time founders test demand for an idea before writing code, from customer interviews to landing page tests.',
  ...
  sections: [
    {
      ...
      body: [
        [
          'The single most-cited statistic behind the entire idea-validation movement is a CB Insights finding, referenced across multiple validation guides, that ',
          { text: '42% of startup failures', bold: true },
          ' are attributable to "no market need" — building something nobody actually wanted enough to pay for (',
          {
            text: 'Reddinbox',
            href: 'https://reddinbox.com/blog/how-to-validate-startup-ideas-on-reddit',
            external: true,
          },
          '; ',
          {
            text: 'Founder Playbook',
            href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
            external: true,
          },
          '). That single failure mode dwarfs most of the other commonly-cited startup killers (running out of cash, wrong team, being outcompeted), which is exactly why validation-before-building has become such a widely repeated piece of startup advice rather than a niche best practice.',
        ],
        [
    ...
    },
    {
      ...
      body: [
        [
          'Guidance across multiple sources converges on a specific, actionable number: ',
          { text: 'roughly 10-20 target users', bold: true },
          ', interviewed in open-ended problem conversations, before building anything (',
          {
            text: '16VC',
            href: 'https://16vc.substack.com/p/how-to-validate-your-startup-idea',
            external: true,
          },
          '; ',
          {
          ...
          '). The emphasis on "open-ended" and "problem" is deliberate — the recommended interview style is explicitly not pitching your idea and gauging reaction. Instead, 16VC\'s framing is to "listen like a detective, not a salesperson": ask how the person currently handles the problem, what frustrates them about their current solution, and what they\'ve already tried, without revealing what you\'re planning to build (',
          {
            text: '16VC',
            href: 'https://16vc.substack.com/p/how-to-validate-your-startup-idea',
            external: true,
        ...
        [
          'Reddinbox\'s guidance adds a practical search-first layer to this: before or alongside interviews, search existing forums and communities (Reddit threads, review sites, support forums) for explicit budget signals — phrases like "current tool costs too much" or "I would pay $X for" — as a cheaper, faster complement to live interviews (',
          {
            text: 'Reddinbox',
            href: 'https://reddinbox.com/blog/how-to-validate-startup-ideas-on-reddit',
            external: true,
    ...
    },
    {
      ...
      body: [
        ...
        [
          "Founder Playbook's framework explicitly splits validation evidence into three tiers, ranked by strength: ",
          { text: 'public data', bold: true },
          ' (search volume, review-site complaints — passive, low-effort to gather but weak signal), ',
          { text: 'direct problem interviews', bold: true },
          ' (medium effort, medium signal, per the section above), and ',
          { text: 'commitment tests', bold: true },
          ' (landing page signups, letters of intent, pre-orders, actual contracts — higher effort to set up but by far the strongest signal, because it requires the person to act rather than just talk) (',
          {
            text: 'Founder Playbook',
            href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
            external: true,
        ...
        [
          'This kind of landing-page-plus-ads test is also notably cheap: guidance puts a basic version — a simple landing page plus a small paid-ads budget to drive traffic and measure email signups or click-through — at roughly ',
          { text: '$50-100', bold: true },
          ' total spend (',
          {
            text: 'Founder Playbook',
            href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
          ...
          {
            text: 'Codevelo',
            href: 'https://codevelo.io/blog/validate-startup-idea-before-building-mvp',
            external: true,
          },
          ').',
        ],
    ...
    },
    {
      ...
      body: [
        [
          ...
          " Buffer's pre-product pricing-page test in 2010, described above, remains the canonical example cited across multiple validation guides — a founder measuring real purchase intent (clicks on a pricing page) before a single line of the product existed (",
          {
            text: 'Founder Playbook',
            href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
            external: true,
    ...
    },
    {
      ...
      body: [
        [
          '– 42% of startup failures attributed to "no market need," per CB Insights, cited across multiple validation guides (',
          {
            text: 'Reddinbox',
            href: 'https://reddinbox.com/blog/how-to-validate-startup-ideas-on-reddit',
            external: true,
        ...
        [
          '– Recommended interview count before building: roughly 10-20 target users (',
          {
            text: '16VC',
            href: 'https://16vc.substack.com/p/how-to-validate-your-startup-idea',
            external: true,
        ...
        [
          "– Buffer's Joel Gascoigne validated demand via a pre-product pricing page in 2010 (",
          {
            text: 'Founder Playbook',
            href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
            external: true,
        ...
        [
          '– A basic landing-page-plus-ads validation test can run for roughly $50-100 (',
          {
            text: 'Founder Playbook',
            href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
            external: true,
        ...
        [
          '– A dedicated open-source-adjacent validation tool ("MVP It") launched via Show HN, indicating real community demand for structured validation tooling (',
          {
            text: 'Hacker News',
            href: 'https://news.ycombinator.com/item?id=43085323',
            external: true,
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Solo, pre-funding founders', bold: true },
          ' use the interview-then-landing-page sequence most commonly, since it requires no capital beyond a small ad budget and no team.',
        ],
        [
          '– ',
          {
            text: 'Founders validating an idea within an existing customer base or community',
            bold: true,
          },
          ' (e.g., a niche professional group) often skip straight to a lightweight pre-order or waitlist test, since they already have direct access to a plausible target audience without needing broad ad spend.',
        ],
        [
          '– ',
          { text: 'Builders creating validation tooling itself', bold: true },
          ' — as with the Show HN-launched "MVP It" — represent a recursive use case: the pain of validating ideas is itself being validated and built into a product (',
          {
            text: 'Hacker News',
            href: 'https://news.ycombinator.com/item?id=43085323',
            external: true,
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          {
            text: 'Pitching the idea during interviews instead of listening.',
            bold: true,
          },
          ' This produces polite, unreliable "yes I\'d use that" responses rather than honest behavioral signal (',
          {
            text: '16VC',
            href: 'https://16vc.substack.com/p/how-to-validate-your-startup-idea',
            external: true,
        ...
        [
          '– ',
          { text: 'Treating verbal interest as validation.', bold: true },
          ' Guides consistently rank commitment tests (landing pages, pre-orders) as stronger evidence than anything someone merely says in conversation (',
          {
            text: 'Founder Playbook',
            href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
            external: true,
        ...
        [
          '– ',
          {
            text: 'Skipping interviews entirely and going straight to a landing page.',
            bold: true,
          },
          ' A landing page test without any prior problem interviews risks testing the wrong framing or audience, wasting the ad spend.',
        ],
        [
          '– ',
          { text: 'Over-interviewing without acting.', bold: true },
          ' Talking to 50+ people without ever running a commitment test delays the actual validation signal that matters most.',
        ],
        [
          '– ',
          {
            text: 'Confusing a large waitlist with proven willingness to pay.',
            bold: true,
          },
          ' Free email signups are a weaker signal than a completed pre-order or an actual card-on-file commitment.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          "Once you've validated a name-worthy concept, the ",
          { text: 'Business Name Generator', href: '/business/business-name-generator' },
          ' and ',
          { text: 'Slogan Generator', href: '/business/slogan-generator' },
          ' can help you quickly produce options for your validation landing page — since the point of this stage is speed, not a perfect brand. Before driving paid traffic to that landing page, run it through the ',
          { text: 'Website Speed Test', href: '/seo/website-speed-test' },
          " to make sure slow load times aren't silently deflating your conversion signal, and use the ",
          { text: 'Marketing ROI Calculator', href: '/seo/marketing-roi-calculator' },
          " to sanity-check whether your ad spend during the test is actually proportionate to what you're trying to learn.",
        ],
        [
          "For the actual customer interview scripts and the landing-page/pricing copy itself, tools.scult.in's ",
          { text: 'business prompt library', href: '/prompts/business-ops' },
          ' and ',
          { text: 'marketing prompt library', href: '/prompts/email-marketing' },
          ' have ready-to-adapt prompts for both stages of this process.',
        ],
        [
          "If validation signals come back strong and you're moving from a landing-page test toward a real working prototype or automated workflows around it, that's often the point where a conversation about AI agents and automation becomes useful — scult.in's ",
          {
            text: 'AI agents & automation service',
            href: SERVICE_AI_CONSULTING.href,
            external: true,
          },
          ' can help turn validated demand into a working first version faster than building everything from scratch solo.',
        ],
      ],
    },
  ],
  faq: [
    ...
    },
    {
      ...
      answer: [
        'Not necessarily — interviews, landing pages, and pre-order tests can validate demand before any product code exists (',
        {
          text: 'Founder Playbook',
          href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Roughly 10-20 target users in open-ended problem interviews is the commonly cited range (',
        {
          text: '16VC',
          href: 'https://16vc.substack.com/p/how-to-validate-your-startup-idea',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'A basic landing-page-plus-ads test can run for roughly $50-100; interviews themselves are typically free beyond your time (',
        {
          text: 'Founder Playbook',
          href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
          external: true,
    ...
    },
    {
      ...
      answer: [
        '"No market need" — cited by CB Insights as responsible for 42% of startup failures (',
        {
          text: 'Reddinbox',
          href: 'https://reddinbox.com/blog/how-to-validate-startup-ideas-on-reddit',
          external: true,
    ...
    {
      question:
        'What\'s the real difference between a "mention" of interest and real validation?',
      answer: [
        'Verbal interest ("that sounds cool") is weak evidence; a real action — clicking through a pricing page, joining a waitlist, pre-ordering — is validation evidence (',
        {
          text: 'Founder Playbook',
          href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
          external: true,
    ...
    },
    {
      ...
      answer: [
        "Because pitching invites polite, socially-motivated agreement rather than honest insight into the person's actual behavior and pain points (",
        {
          text: '16VC',
          href: 'https://16vc.substack.com/p/how-to-validate-your-startup-idea',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Public data (weakest), direct problem interviews (medium), and commitment tests like landing pages or pre-orders (strongest) (',
        {
          text: 'Founder Playbook',
          href: 'https://founderplaybook.substack.com/p/how-to-test-your-startup-idea-without',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Yes — searching for explicit complaint or budget-signal language in existing threads is a recommended low-cost validation research method (',
        {
          text: 'Reddinbox',
          href: 'https://reddinbox.com/blog/how-to-validate-startup-ideas-on-reddit',
          external: true,
    ...
    {
      question:
        'Is 42% a universally agreed statistic across all startup-failure research?',
      answer: [
    ...
    {
      question:
        "How do I find potential interview subjects if I don't have an existing audience?",
      answer: [
    ...
    {
      question:
        'How do I test willingness to pay specifically, not just general interest?',
      answer: [
    ...
    {
      question:
        'How do I decide if my validation results are strong enough to start building?',
      answer: [
    ...
    {
      question:
        'Does validation differ for a marketplace business versus a single-sided product?',
      answer: [
    ...
    {
      question:
        'Pre-order vs simple email waitlist — which is the stronger validation signal?',
      answer: [
    ...
    {
      question:
        'My interviews all went well but nobody joined my landing-page waitlist — what happened?',
      answer: [
    ...
    {
      question:
        "I validated demand but I'm not sure how to price the product — now what?",
      answer: [
    ...
    {
      question:
        "My idea seems validated but I'm worried it's too small a market — how do I check?",
      answer: [
    ...
    },
    {
      ...
      answer: [
        'Guides suggest a range from a few intensive weeks (compressed AI-era approach: interviews then rapid shipping) up to roughly 4-8 weeks for a more thorough process including AI-assisted research (',
        {
          text: 'Medium — Ideas With Wings',
          href: 'https://medium.com/ideas-with-wings/how-to-validate-a-startup-idea-before-building-2026-ai-framework-a8237c7ed0a6',
          external: true,
