...
export const meta: BlogPost = {
  ...
  description:
    "Do UK freelancers charge VAT on international invoices? Usually no for B2B clients, usually yes for consumers. Here's the place-of-supply rules explained.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        [
          { text: 'B2B vs. B2C VAT rules.', bold: true },
          " B2B: place of supply follows the customer, UK VAT generally not charged, reverse charge applies on the client's end. B2C: place of supply follows the supplier (with the digital-services exception), UK VAT generally charged at the standard rate. Getting the client's status wrong is the single most common source of VAT invoicing errors for freelancers working internationally.",
        ],
        [
          { text: 'VAT MOSS vs. the current One Stop Shop framework.', bold: true },
          ' VAT MOSS was the original EU mechanism letting digital-service sellers report VAT across the bloc through one registration instead of many; it has since been folded into the broader EU One Stop Shop (OSS) system. The underlying purpose — simplifying multi-country VAT reporting for digital sellers — remains the same even as the specific scheme name and scope have evolved.',
        ],
        [
          {
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          {
            text: 'A UK freelance consultant with mostly EU business clients',
            bold: true,
          },
          ': applies the B2B general rule to most invoices, meaning most invoices carry no UK VAT line and instead reference the reverse charge — provided VAT numbers or other business evidence are kept on file.',
        ],
        [
          '– ',
          {
            text: 'A UK freelancer selling a digital product (course, template pack, software) directly to consumers globally',
            bold: true,
          },
          ": needs to specifically check the digital-services exception rather than assuming the general B2C rule (UK VAT) applies uniformly, since digital B2C sales shift the place of supply to the consumer's country.",
        ],
        [
          '– ',
          {
            text: 'A UK freelancer who subcontracts significant work overseas',
            bold: true,
          },
          ': needs to track the value of B2B services received from abroad against the £90,000 threshold, since that spend counts even without matching UK sales revenue.',
        ],
        [
          '– ',
          { text: 'A UK freelancer weighing voluntary VAT registration', bold: true },
          ': this is a real, common decision point below the £90,000 threshold, often driven by wanting to reclaim VAT on business expenses or appear more established to VAT-registered B2B clients.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          'Getting the invoice format right matters as much as getting the VAT treatment right — the ',
          { text: 'Invoice Generator', href: '/business/invoice-generator' },
          " gives you a clean starting point for building compliant invoices, including the fields you need to record a client's VAT number and note reverse-charge treatment on B2B invoices to international clients.",
        ],
        [
