...
export const meta: BlogPost = {
  ...
  description:
    'How solo freelancers actually track and send multi-currency invoices to international clients without hiring an accountant or bookkeeper.',
  ...
  sections: [
    {
      ...
      body: [
        [
          ...
          {
            text: 'HN Algolia',
            href: 'https://hn.algolia.com/api/v1/search?query=freelancer%20invoice%20multiple%20currencies',
            external: true,
          },
          '). This mismatch between the problem (a handful of invoices, a few currencies) and the solution (subscription-priced, feature-heavy accounting suites built for teams and books) is the entire reason a small ecosystem of minimal, purpose-built tools keeps getting built by freelancers themselves rather than everyone converging on one dominant platform.',
        ],
        [
    ...
    },
    {
      ...
      body: [
        ...
        [
          { text: 'The DIY route.', bold: true },
          ' Some freelancers skip tools entirely and write something minimal for themselves — a documented example is a roughly 100-line command-line script built by one freelancer purely to generate their own multi-currency invoices, rather than adopting any existing software at all (',
          {
            text: 'HN Algolia',
            href: 'https://hn.algolia.com/api/v1/search?query=freelancer%20invoice%20multiple%20currencies',
            external: true,
          },
          '). This is the clearest possible evidence that the "gap" between what freelancers need and what mainstream tools offer is real enough that technically capable freelancers will build their own rather than pay for or configure an existing platform.',
        ],
        [
          { text: 'Minimal purpose-built products.', bold: true },
          ' Several small, focused tools have been launched specifically to fill this gap:',
        ],
        [
          '– ',
          { text: 'Invoroo', bold: true },
          ' — minimal multi-currency, multi-language invoicing, built and launched as a small, focused product rather than a full accounting suite (',
          {
            text: 'HN Algolia',
            href: 'https://hn.algolia.com/api/v1/search?query=freelancer%20invoice%20multiple%20currencies',
            external: true,
        ...
        [
          '– ',
          { text: 'klirr', bold: true },
          ' — an open-source, Rust-based tool that automates exchange-rate conversion and emailing of invoices, appealing specifically to freelancers comfortable with (or wanting) a self-hosted, code-level solution rather than a SaaS subscription (',
          {
            text: 'HN Algolia',
            href: 'https://hn.algolia.com/api/v1/search?query=multi%20currency%20invoicing%20freelancer',
            external: true,
          },
          ').',
        ],
        [
          '– ',
          { text: 'PlainInvoice', bold: true },
          ' — no-login, instant invoice generation with multi-currency support, aimed at the simplest possible use case: generate one invoice right now, no account setup required (',
          {
            text: 'HN Algolia',
            href: 'https://hn.algolia.com/api/v1/search?query=multi%20currency%20invoicing%20freelancer',
            external: true,
        ...
        [
          { text: 'Chat-native tools for informal markets.', bold: true },
          ' A WhatsApp-based invoicing bot was built specifically to help freelancers and informal businesses in markets like Nigeria, India, Brazil, and Southeast Asia create and track invoices inside a chat interface rather than a traditional web app (',
          {
            text: 'HN Algolia',
            href: 'https://hn.algolia.com/api/v1/search?query=multi%20currency%20invoicing%20freelancer',
            external: true,
          },
          ') — a notably different design assumption than the Western-market default of "open a web dashboard," reflecting where freelancers in those markets actually spend their time digitally.',
        ],
        [
    ...
    },
    {
      ...
      body: [
        ...
        [
          { text: 'Wise', bold: true },
          ' converts at the mid-market exchange rate with no markup on the conversion itself, instead charging a transparent fee starting around 0.33% variable plus a small fixed fee per transfer, with total cost typically ranging from roughly 0.33% to about 2% depending on the currency pair and payment method (',
          {
            text: 'Wise',
            href: 'https://wise.com/gb/blog/best-multi-currency-invoicing-software',
            external: true,
          },
          '; ',
          {
            text: 'EarnifyHub',
            href: 'https://earnifyhub.com/finance-money/wise-vs-paypal-international-payments-2026',
            external: true,
          },
          "). You can hold, send, and receive 40+ currencies in one account, with local account details in 8+ currencies letting you receive payments as if you were a local entity in those markets — genuinely useful for a freelancer regularly invoicing clients in, say, the EU and the UK from a base elsewhere. The tradeoff: Wise does not include invoicing or payment-collection functionality itself — it's purely the money-movement layer, meant to be paired with a separate invoicing tool.",
        ],
        [
          { text: 'PayPal', bold: true },
          ', by contrast, charges international transaction fees of roughly 4.4% plus $0.30, plus a currency-conversion markup of an additional 3-4% — meaning a single international payment can cost between roughly 6% and 7% of the invoice value once both fees are combined (',
          {
            text: 'EarnifyHub',
            href: 'https://earnifyhub.com/finance-money/wise-vs-paypal-international-payments-2026',
            external: true,
          },
          '). For a freelancer invoicing meaningful amounts regularly, that gap compounds fast.',
        ],
        [
          { text: 'Stripe', bold: true },
          " is generally described as the stronger primary tool specifically for card-based checkout — getting paid at all, especially from clients who want to pay by card rather than bank transfer — while Wise is positioned as the cheaper way to actually convert and hold the money afterward. The practical guidance that recurs: use Stripe to get paid, use Wise to keep more of what you're paid (",
          {
            text: 'Delivvo',
            href: 'https://delivvo.io/blog/stripe-vs-paypal-vs-wise-for-freelancers',
            external: true,
          },
          '; ',
          {
            text: 'Ruul',
            href: 'https://ruul.io/blog/best-payment-methods',
            external: true,
          },
          ').',
        ],
        [
          "Fee structures aren't static, either — reported 2026 updates put Wise's own fees rising to roughly 0.5-0.75% by mid-2026, attributed to rising compliance costs, meaning even the cheaper option's advantage narrows somewhat over time and is worth periodically re-checking rather than assuming a fee structure from a year or two ago still holds exactly (",
          {
            text: 'EarnifyHub',
            href: 'https://earnifyhub.com/finance-money/wise-vs-paypal-international-payments-2026',
            external: true,
    ...
    },
    {
      ...
      body: [
        ...
        [
          'A documented real-world example: a Venezuelan freelance programmer found getting paid in Bitcoin "orders of magnitude easier than any other alternative," specifically because of banking and currency restrictions in his country that made conventional payment rails impractical or unavailable (',
          {
            text: 'dergigi.com',
    ...
    },
    {
      ...
      body: [
        [
          { text: 'Real example — the 100-line CLI invoice tool.', bold: true },
          ' A freelancer, frustrated with existing options, wrote a roughly 100-line command-line script that handles their own multi-currency invoice generation — a real, documented instance of the build-it-yourself pattern rather than adopting existing software (',
          {
            text: 'HN Algolia',
            href: 'https://hn.algolia.com/api/v1/search?query=freelancer%20invoice%20multiple%20currencies',
            external: true,
        ...
        [
          { text: "Real example — klirr's open-source approach.", bold: true },
          ' klirr is a real, publicly available open-source tool (built in Rust) that automates exchange-rate conversion and invoice emailing — a documented middle ground between "write your own script" and "pay for a SaaS subscription" (',
          {
            text: 'HN Algolia',
            href: 'https://hn.algolia.com/api/v1/search?query=multi%20currency%20invoicing%20freelancer',
            external: true,
        ...
        [
          {
            text: "Real example — the Venezuelan freelancer's Bitcoin payment solution.",
            bold: true,
          },
          " A genuinely documented first-person account of a freelancer solving cross-border payment access, not through any invoicing tool improvement, but by routing around traditional banking entirely given his country's specific restrictions (",
          {
            text: 'dergigi.com',
            href: 'https://dergigi.com/2021/01/14/bitcoin-is-time/',
            external: true,
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Wise', bold: true },
          ': ~0.33%-2% total cost depending on currency pair and method, converting at the mid-market rate with no markup; fees reportedly rising to ~0.5-0.75% by mid-2026 due to compliance costs; supports 40+ currencies and local account details in 8+ currencies; does not include invoicing functionality itself (',
          {
            text: 'Wise',
            href: 'https://wise.com/gb/blog/best-multi-currency-invoicing-software',
            external: true,
        ...
        [
          '– ',
          { text: 'PayPal', bold: true },
          ': ~4.4% + $0.30 international transaction fee, plus a 3-4% currency-conversion markup — combined cost roughly 6-7% of invoice value for an international payment (',
          {
            text: 'EarnifyHub',
            href: 'https://earnifyhub.com/finance-money/wise-vs-paypal-international-payments-2026',
            external: true,
        ...
        [
          '– ',
          { text: 'FreeAgent', bold: true },
          ': multi-currency and multi-lingual invoicing starting around £190/year for sole traders, £330/year for limited companies (',
          {
            text: 'Wise',
            href: 'https://wise.com/gb/blog/best-multi-currency-invoicing-software',
            external: true,
        ...
        [
          '– ',
          { text: 'QuickBooks Online', bold: true },
          ': multi-currency invoicing requires Essentials (~£38/month), Plus (~£56/month), or Advanced (~£123/month) plans (',
          {
            text: 'Wise',
            href: 'https://wise.com/gb/blog/best-multi-currency-invoicing-software',
            external: true,
        ...
        [
          "– A documented real-world example of a freelancer using Bitcoin specifically because conventional banking/currency rails weren't practically available in his country (",
          {
            text: 'dergigi.com',
            href: 'https://dergigi.com/2021/01/14/bitcoin-is-time/',
            external: true,
        ...
        [
          '– Multiple named minimal/open-source tools exist specifically for this niche: Invoroo, klirr, PlainInvoice, and a WhatsApp-based invoicing bot targeting Nigeria, India, Brazil, and Southeast Asia (',
          {
            text: 'HN Algolia',
            href: 'https://hn.algolia.com/api/v1/search?query=multi%20currency%20invoicing%20freelancer',
            external: true,
    ...
    },
    {
      ...
      body: [
        [
          { text: 'Wise vs. PayPal for freelancer invoicing.', bold: true },
          " Wise is meaningfully cheaper for currency conversion (roughly 0.33-2% total versus PayPal's combined ~6-7%) and offers multi-currency holding, but doesn't generate invoices itself — you need a separate invoicing tool paired with it. PayPal is more universally recognized and trusted by clients unfamiliar with Wise, and offers built-in invoicing, but at a substantially higher currency-conversion cost.",
        ],
        [
          {
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'A freelance developer comfortable with code', bold: true },
          ' self-hosts klirr to automate exchange-rate conversion and invoice emailing, avoiding any recurring SaaS subscription entirely.',
        ],
        [
          '– ',
          { text: 'A freelancer who just needs one invoice right now', bold: true },
          " uses PlainInvoice's no-login, instant generation to produce a single multi-currency invoice without setting up an account at all.",
        ],
        [
          '– ',
          {
            text: 'A freelancer receiving payments from clients across the EU and UK',
            bold: true,
          },
          ' uses Wise specifically for its multi-currency holding and local account details in multiple currencies, pairing it with a separate lightweight invoicing tool for the actual invoice documents.',
        ],
        [
          '– ',
          {
            text: 'An informal freelancer or small business operator in Nigeria, India, or Brazil',
            bold: true,
          },
          ' uses a WhatsApp-based invoicing bot to create and track invoices inside the chat app they already use daily, rather than adopting a Western-style web dashboard tool.',
        ],
        [
          '– ',
          { text: 'A freelancer in a country with banking restrictions', bold: true },
          " routes around the constraint entirely using a payment method like Bitcoin, as documented in the Venezuelan freelancer's real account, when conventional banking access is the actual blocker rather than invoicing software choice.",
        ],
      ],
    },
    {
      ...
      body: [
        [
          '– ',
          {
            text: 'Assuming a full accounting suite (FreshBooks, QuickBooks) is necessary just to send a few multi-currency invoices a month',
            bold: true,
          },
          ' — this is precisely the cost-and-complexity mismatch driving freelancers toward minimal, purpose-built alternatives.',
        ],
        [
          '– ',
          {
            text: 'Using PayPal for regular high-value international payments without checking the real combined fee',
            bold: true,
          },
          " — the roughly 6-7% combined cost of PayPal's transaction fee plus conversion markup is a substantial, often underestimated drain compared to Wise's lower cost.",
        ],
        [
          '– ',
          {
            text: 'Confusing "I want simpler invoicing" with "I can\'t access normal banking rails"',
            bold: true,
          },
          ' — these are different problems with completely different solutions, and misdiagnosing which one you actually have wastes time on the wrong fix.',
        ],
        [
          '– ',
          {
            text: 'Assuming your invoicing tool has handled tax reconciliation for you',
            bold: true,
          },
          ' — most minimal and DIY tools solve invoice generation, not the harder problem of tracking exchange rates at each actual payment date for accurate tax reporting.',
        ],
        [
          '– ',
          {
            text: 'Not tracking the exchange rate at the actual date of each payment received',
            bold: true,
          },
          ", which is generally necessary for accurate tax reporting on foreign-currency income, and which most lightweight invoicing tools don't automate.",
        ],
        [
          '– ',
          {
            text: 'Picking a payment platform based on brand recognition alone',
            bold: true,
          },
          ' rather than comparing actual combined fees for your specific currency pairs and typical invoice amounts.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          'For generating a quick, professional multi-currency invoice without a subscription commitment, the ',
          { text: 'invoice generator', href: '/business/invoice-generator' },
          ' is a direct fit for the exact "I just need to send one clean invoice right now" need this topic centers on. For structuring the tax-tracking and reconciliation side this article flags as a genuine gap, the ',
          { text: 'finance prompts', href: '/prompts/finance' },
          ' collection offers reusable starting points for building your own simple tracking system with an AI assistant.',
        ],
        [
          "If your international invoicing and payment-tracking needs have grown past what a spreadsheet and a free tool can comfortably handle — multiple currencies, growing client volume, or a genuinely custom workflow — that's the kind of scoped build ",
          {
            text: "SCULT's custom software service",
            href: SERVICE_CUSTOM_SOFTWARE.href,
            external: true,
          },
          ' is set up to handle, rather than continuing to patch together separate free tools indefinitely.',
        ],
      ],
    },
  ],
  faq: [
    {
      question:
        'Why do freelancers build their own invoicing tools instead of using existing software?',
      answer: [
        'Existing platforms are frequently described as "overly complex and expensive" for a solo freelancer\'s simple multi-currency needs, pushing some to build minimal personal tools instead (',
        {
          text: 'HN Algolia',
          href: 'https://hn.algolia.com/api/v1/search?query=freelancer%20invoice%20multiple%20currencies',
          external: true,
    ...
    {
      question:
        'What lightweight tools exist for multi-currency invoicing without an accountant?',
      answer: [
        'Documented examples include Invoroo, klirr (open-source), and PlainInvoice (no-login instant generation) (',
        {
          text: 'HN Algolia',
          href: 'https://hn.algolia.com/api/v1/search?query=multi%20currency%20invoicing%20freelancer',
          external: true,
    ...
    {
      question:
        'How do freelancers in countries with restricted banking get paid by international clients?',
      answer: [
        'Some route around traditional banking entirely — a documented example is a Venezuelan freelancer using Bitcoin specifically because of banking/currency restrictions in his country (',
        {
          text: 'dergigi.com',
          href: 'https://dergigi.com/2021/01/14/bitcoin-is-time/',
          external: true,
    ...
    {
      question:
        'Are there invoicing tools built for chat apps rather than web dashboards?',
      answer: [
        'Yes — a WhatsApp-based invoicing bot was built specifically for freelancers and informal businesses in markets like Nigeria, India, Brazil, and Southeast Asia (',
        {
          text: 'HN Algolia',
          href: 'https://hn.algolia.com/api/v1/search?query=multi%20currency%20invoicing%20freelancer',
          external: true,
    ...
    {
      question:
        "What's the difference between converting currency for display versus reconciling income for taxes?",
      answer: [
    ...
    {
      question:
        'Why do freelancers avoid FreshBooks or QuickBooks for simple multi-currency needs?',
      answer: [
    ...
    {
      question:
        'What is Wise, and how does it help with multi-currency freelance income?',
      answer: [
    ...
    {
      question:
        'Why is there no single dominant tool for freelancer multi-currency invoicing?',
      answer: [
    ...
    {
      question:
        'How do I choose between a spreadsheet and an invoicing app for multi-currency tracking?',
      answer: [
    ...
    {
      question:
        'How do I decide if I need a full accounting suite or a minimal invoicing tool?',
      answer: [
    ...
    {
      question:
        'How do I handle currency conversion for a client who wants to pay in their own currency but I need my home currency?',
      answer: [
    ...
    {
      question:
        'How do I decide whether Stripe or PayPal is better for collecting card payments internationally?',
      answer: [
    ...
    {
      question:
        'How do I avoid losing money to bank conversion fees when receiving international wire transfers?',
      answer: [
    ...
    {
      question:
        'Advanced: how do I reconcile multi-currency income for annual tax filing?',
      answer: [
    ...
    {
      question:
        "Advanced: should I invoice in my client's currency or my own home currency?",
      answer: [
    ...
    {
      question:
        'Advanced: how do exchange-rate fluctuations between invoicing and payment receipt affect my actual income?',
      answer: [
    ...
    {
      question:
        'Advanced: is there a way to hedge against currency fluctuation as a solo freelancer?',
      answer: [
    ...
    {
      question:
        'Advanced: do any of these tools integrate with tax-filing software directly?',
      answer: [
    ...
    {
      question:
        'Spreadsheet vs. invoicing app — which is actually better for a solo freelancer?',
      answer: [
    ...
    {
      question:
        'DIY invoice tool vs. paid invoicing software — which is the better long-term choice?',
      answer: [
    ...
    {
      question:
        "My client wants to pay via bank transfer in their local currency — what's my cheapest option to receive it?",
      answer: [
    ...
    {
      question:
        'My PayPal fees are eating a big chunk of my invoice — what should I switch to?',
      answer: [
    ...
    {
      question:
        "I have clients in three different currencies and I'm losing track of exchange rates — what should I do?",
      answer: [
    ...
    {
      question:
        'My country has limited access to standard international payment platforms — what are my options?',
      answer: [
    ...
    {
      question:
        "I'm spending too much time formatting invoices manually every month — what's the fix?",
      answer: [
    ...
    {
      question:
        "I want to stop paying for QuickBooks just for occasional multi-currency invoices — what's a cheaper alternative?",
      answer: [
    ...
    },
    {
      ...
      answer: [
        'For simple, occasional needs, yes — tools like ',
        { text: 'invoice-generator', href: '/business/invoice-generator' },
        ' can produce a professional multi-currency invoice quickly without a subscription commitment.',
      ],
    },
    {
    ...
    },
    {
      ...
      answer: [
        'A straightforward, no-cost option worth trying first is ',
        {
          text: "tools.scult.in's invoice generator",
          href: '/business/invoice-generator',
        },
        ', which supports creating professional invoices without a subscription commitment.',
      ],
    },
    {
      question:
        'Is it worth paying for a dedicated multi-currency invoicing SaaS instead of a free tool?',
      answer: [
    ...
    {
      question:
        "What's the cheapest full stack for a freelancer just starting to bill international clients?",
      answer: [
    ...
    {
      question:
        'Is DIY multi-currency invoicing sustainable long-term, or will I eventually need real accounting help?',
      answer: [
