...
export const meta: BlogPost = {
  ...
  description:
    'Learn what an AI citation actually looks like, which free and paid tools track them, and how to check if ChatGPT, Perplexity, or Google AI Overviews cite your site.',
  ...
  sections: [
    {
      ...
      body: [
        [
          ...
          { text: 'Otterly.ai', href: 'https://otterly.ai/', external: true },
          ').',
        ],
        [
          ...
          {
            text: 'Forbes Agency Council',
            href: 'https://www.forbes.com/councils/forbesagencycouncil/2026/06/29/how-agencies-can-tap-into-better-ai-citation-results/',
            external: true,
          },
          ').',
        ],
        ...
        [
          '– ',
          { text: 'ChatGPT', bold: true },
          ' (in web-search mode) shows small numbered footnotes or a "Sources" strip beneath a response, each linking to a specific page.',
        ],
        [
          '– ',
          { text: 'Perplexity', bold: true },
          ' shows numbered citation bubbles inline in the answer text, with a sources panel listing every domain used.',
        ],
        [
          '– ',
          { text: 'Google AI Overviews', bold: true },
          ' and ',
          { text: 'AI Mode', bold: true },
          ' show a card or carousel of linked sources alongside (or within) the generated summary, often several links per answer rather than one.',
        ],
        [
          '– ',
          { text: 'Gemini', bold: true },
          ', when grounded with Search, behaves similarly to AI Overviews, surfacing a small set of linked sources.',
        ],
        [
          'Research from BrightEdge, reported by Search Engine Journal, adds an important wrinkle: AI engines don\'t just retrieve and rank sources the way classic search does. They appear to assign different sources different "jobs" inside a single answer — one citation might serve as the authority reference, another as social proof, another as a how-to walkthrough — depending on the query type (',
          {
          ...
          '). That means the same page might get cited for a comparison query but not for a direct "what is X" query, even on the identical topic.',
        ],
      ],
    },
    {
      ...
      body: [
        ...
        [
          '1. ',
          { text: 'Query the engines directly.', bold: true },
        ...
        [
          '2. ',
          { text: 'Repeat each query 3-5 times.', bold: true },
          ' AI answers are non-deterministic — the same prompt can return different sources on different runs, so a single check is not a reliable "yes/no."',
        ],
        [
          '3. ',
          { text: 'Check incognito/logged-out sessions too', bold: true },
          ', since personalization and prior chat history can bias which sources reappear for you specifically versus a new customer.',
        ],
        [
          '4. ',
          { text: 'Search your brand name directly', bold: true },
          " in each engine to see if it can describe you at all — if the base description is wrong or missing, that's often the reason you're not being cited for topic queries, before you even get to citation tracking.",
        ],
        [
    ...
    },
    {
      ...
      body: [
        ...
        [
          { text: 'Free / freemium checkers.', bold: true },
          ' Semrush offers a free AI Search Visibility Checker that shows brand mentions and citations across ChatGPT, Gemini, AI Mode, and AI Overviews for a given domain (',
          {
            text: 'Semrush',
            href: 'https://www.semrush.com/free-tools/ai-search-visibility-checker/',
            external: true,
          },
          '). Several other vendors, including Frase, Answer Visibility Lab, and various point tools, run one-off free checks that show which domains got cited for a sample set of prompts related to yours (',
          {
            text: 'Frase',
            href: 'https://www.frase.io/blog/the-10-best-ai-visibility-tools-in-2026',
            external: true,
          },
          ').',
        ],
        [
          { text: 'Open-source monitors.', bold: true },
          ' Canonry and Elmo are two AEO (answer-engine optimization) monitoring tools that launched as open-source projects on GitHub, letting technically capable teams run their own prompt sets against multiple AI engines and log citation results without paying a SaaS subscription (',
          { text: 'Canonry', href: 'https://github.com/AINYC/canonry', external: true },
          '; ',
          { text: 'Elmo', href: 'https://github.com/elmohq/elmo', external: true },
          ').',
        ],
        [
          { text: 'Paid platforms.', bold: true },
          ' Otterly.ai, Profound, Peec AI, SE Ranking\'s AI toolkit, and enterprise entrants like Somantra (which launched a "Brand Consideration Score" metric specifically for this category) run scheduled prompt sets across ChatGPT, Perplexity, Gemini, and Google AI Overviews on your behalf, tracking citation share over time, competitor comparisons, and which specific pages get pulled in (',
          { text: 'Otterly.ai', href: 'https://otterly.ai/', external: true },
          '; ',
          {
            text: 'Somantra via Yahoo Finance',
            href: 'https://finance.yahoo.com/technology/ai/articles/somantra-enterprise-grade-answer-engine-130000005.html',
            external: true,
          },
          ').',
        ],
        [
          { text: 'Community-driven tools.', bold: true },
          " Spiderseek and Prominara are newer entrants that launched via Hacker News's Show HN, indicating genuine grassroots builder demand for this exact problem rather than only top-down enterprise tooling (",
          { text: 'Spiderseek', href: 'https://www.spiderseek.com', external: true },
          '; Prominara). The existence of multiple independently-built open-source and indie tools solving the same problem is itself decent evidence that "am I being cited by AI" has become a real, felt pain point rather than a hypothetical one.',
        ],
        [
          'A 2026 industry aggregation — described as an "AI Platform Citation Source Index" — synthesized roughly 680 million tracked AI citations pulled from nine separate third-party studies (Similarweb, Semrush, Ahrefs, Profound, Peec AI, SE Ranking, and others), covering ChatGPT, Claude, Perplexity, Gemini, and Google AI Overviews (',
          {
            text: 'Forbes Agency Council',
            href: 'https://www.forbes.com/councils/forbesagencycouncil/2026/06/29/how-agencies-can-tap-into-better-ai-citation-results/',
            external: true,
          },
          '). That scale of aggregated tracking is a strong signal that citation monitoring has moved from a niche experiment to a mainstream measurement category within about two years of AI Overviews and ChatGPT search becoming mainstream.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          '– Otterly.ai\'s own product framing distinguishes a "citation" (linked source) from a "mention" (unlinked brand name) as the foundational unit tracked by AI-visibility tools (',
          { text: 'Otterly.ai', href: 'https://otterly.ai/', external: true },
          ').',
        ],
        [
          "– Google's Search Console AI-surface reporting was in limited rollout to a subset of UK site owners as of the June 2026 announcement, with country-level impression breakdowns planned (",
          {
            text: '9to5Google',
            href: 'https://9to5google.com/2026/06/02/google-ai-mode-overviews-opt-out/',
            external: true,
        ...
        [
          "– The AI Overviews/AI Mode opt-out toggle in Search Console does not affect regular Search rankings, per Google's own statement (",
          {
            text: '9to5Google',
            href: 'https://9to5google.com/2026/06/02/google-ai-mode-overviews-opt-out/',
            external: true,
        ...
        [
          '– A 2026 cross-vendor synthesis tracked roughly 680 million AI citations across nine independent studies spanning five major AI platforms (',
          {
            text: 'Forbes Agency Council',
            href: 'https://www.forbes.com/councils/forbesagencycouncil/2026/06/29/how-agencies-can-tap-into-better-ai-citation-results/',
            external: true,
        ...
        [
          '– BrightEdge research indicates AI engines assign different sources different functional roles within an answer rather than uniformly ranking them the way classic search does (',
          {
            text: 'Search Engine Journal',
            href: 'https://www.searchenginejournal.com/research-suggests-ai-engines-assign-ranking-roles-to-sources/578620/',
            external: true,
    ...
    },
    {
      ...
      body: [
        [
          ...
          ' are increasingly asked by clients to report "citation share" alongside traditional SEO KPIs like rankings and organic traffic, per Forbes Agency Council commentary on how agencies are adapting their reporting stack (',
          {
            text: 'Forbes',
            href: 'https://www.forbes.com/councils/forbesagencycouncil/2026/06/29/how-agencies-can-tap-into-better-ai-citation-results/',
            external: true,
        ...
        [
          '– ',
          { text: 'Open-source builders', bold: true },
          " created Canonry and Elmo specifically because existing paid AEO tools didn't fit budget-constrained or privacy-sensitive teams, and both launched to community attention on GitHub/Hacker News-adjacent channels (",
          { text: 'Canonry', href: 'https://github.com/AINYC/canonry', external: true },
          '; ',
          { text: 'Elmo', href: 'https://github.com/elmohq/elmo', external: true },
          ').',
        ...
        [
          '– ',
          { text: 'Enterprise brand teams', bold: true },
          " are adopting purpose-built scoring systems like Somantra's Brand Consideration Score to turn raw citation data into a single trackable metric leadership can monitor quarter over quarter (",
          {
            text: 'Yahoo Finance',
            href: 'https://finance.yahoo.com/technology/ai/articles/somantra-enterprise-grade-answer-engine-130000005.html',
            external: true,
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Treating one prompt run as definitive.', bold: true },
          ' AI answers vary run to run; a single "not cited" result doesn\'t mean you never get cited for that query.',
        ],
        [
          '– ',
          { text: 'Confusing a mention with a citation.', bold: true },
          " Being named without a link is a much weaker outcome and shouldn't be reported to a client as equivalent to a citation.",
        ],
        [
          '– ',
          { text: 'Ignoring engine-specific behavior.', bold: true },
          ' Assuming that fixing your Google AI Overview presence will automatically fix ChatGPT or Perplexity citations — the BrightEdge research on source "roles" suggests each engine can behave quite differently for the same query.',
        ],
        [
          '– ',
          {
            text: "Waiting for Search Console's AI reporting to cover everything.",
            bold: true,
          },
          " It will only ever report on Google's own AI surfaces, not ChatGPT, Perplexity, or Gemini's standalone app.",
        ],
        [
          '– ',
          { text: 'Not checking logged-out/incognito.', bold: true },
          ' Personalization can distort what you see versus what an average new user sees.',
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          'Run your own domain through the ',
          { text: 'AI Visibility Checker', href: '/geo/ai-visibility-checker' },
          ' to get an immediate, free baseline read on whether AI engines currently mention or cite your site before investing in a paid tracking subscription.',
        ],
        [
          "If you're finding real gaps between how you rank on Google and how you show up in AI answers, that's often a signal worth a conversation with a team that treats GEO/AEO as a distinct discipline from classic SEO — scult.in's ",
          {
            text: 'SEO & GEO services',
            href: SERVICE_SEO_COMPANIES_FOR_SMALL_BUSINESS.href,
            external: true,
          },
          ' work through exactly this kind of citation-share diagnosis and the content/technical fixes that follow from it.',
        ],
        [
  ...
  faq: [
    ...
    },
    {
      ...
      answer: [
        'No — a mention is just your name appearing in the text; a citation includes a link or explicit source attribution (',
        { text: 'Otterly.ai', href: 'https://otterly.ai/', external: true },
        ').',
      ],
    },
    ...
    },
    {
      ...
      answer: [
        'Yes, several vendors offer free one-off or limited checks, including Semrush (',
        {
          text: 'Semrush',
          href: 'https://www.semrush.com/free-tools/ai-search-visibility-checker/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        "It's rolling out new AI-surface reporting, but as of mid-2026 it was in limited testing, not fully available to all site owners (",
        {
          text: '9to5Google',
          href: 'https://9to5google.com/2026/06/02/google-ai-mode-overviews-opt-out/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'No — Forbes Agency Council commentary frames citation share as something agencies are now reporting for clients of many sizes, including small businesses (',
        {
          text: 'Forbes',
          href: 'https://www.forbes.com/councils/forbesagencycouncil/2026/06/29/how-agencies-can-tap-into-better-ai-citation-results/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Research suggests they assign different sources different functional "roles" in an answer depending on query type, rather than applying one uniform ranking (',
        {
          text: 'Search Engine Journal',
          href: 'https://www.searchenginejournal.com/research-suggests-ai-engines-assign-ranking-roles-to-sources/578620/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'The percentage of citations for a given topic or query set that go to your domain versus competitors (',
        {
          text: 'Forbes',
          href: 'https://www.forbes.com/councils/forbesagencycouncil/2026/06/29/how-agencies-can-tap-into-better-ai-citation-results/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'They can be, if your team has the technical capacity to run and maintain them; Canonry and Elmo are both real, actively shared open-source projects (',
        { text: 'Canonry', href: 'https://github.com/AINYC/canonry', external: true },
        '; ',
        { text: 'Elmo', href: 'https://github.com/elmohq/elmo', external: true },
        ').',
    ...
    },
    {
      ...
      answer: [
        'A 2026 industry synthesis aggregating roughly 680 million tracked citations from nine separate studies across five major AI platforms (',
        {
          text: 'Forbes',
          href: 'https://www.forbes.com/councils/forbesagencycouncil/2026/06/29/how-agencies-can-tap-into-better-ai-citation-results/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'No — Google stated the opt-out control does not affect classic Search ranking (',
        {
          text: '9to5Google',
          href: 'https://9to5google.com/2026/06/02/google-ai-mode-overviews-opt-out/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Yes — reporting indicates Reddit in particular carries a disproportionate share of AI citations relative to its size (',
        {
          text: 'Entrepreneur',
          href: 'https://www.entrepreneur.com/building-a-business/your-brand-will-be-invisible-in-ai-search-if-youre-not-showing-up-on-these-8-channels',
          external: true,
    ...
    {
      question:
        'Is "citation" the correct technical term across the whole industry, or do vendors use different words?',
      answer: [
    ...
    {
      question:
        "How do I check if Google's new AI Search Console reporting is available to me yet?",
      answer: [
        "Check your Search Console property's Performance report for a new AI-surface filter or report section; as of mid-2026 it was limited to a subset of UK properties (",
        {
          text: '9to5Google',
          href: 'https://9to5google.com/2026/06/02/google-ai-mode-overviews-opt-out/',
          external: true,
    ...
    {
      question:
        'Do different AI engines weight the same source differently by query type?',
      answer: [
        'Yes — this is exactly what BrightEdge\'s "source roles" research describes: the same domain can be an authority citation in one context and absent in another (',
        {
          text: 'Search Engine Journal',
          href: 'https://www.searchenginejournal.com/research-suggests-ai-engines-assign-ranking-roles-to-sources/578620/',
          external: true,
    ...
    {
      question:
        'Can citation tracking data be exported for reporting to clients or leadership?',
      answer: [
    ...
    {
      question:
        'Is there an industry-standard citation-share benchmark I should aim for?',
      answer: [
    ...
    {
      question:
        "Ahrefs Brand Radar vs Semrush's AI Toolkit — which is better for citation tracking?",
      answer: [
    ...
    {
      question:
        'ChatGPT search vs Google AI Overviews citations — which is easier to earn?',
      answer: [
    ...
    {
      question:
        'My brand feels invisible in AI search across the board — where do I start?',
      answer: [
    ...
    {
      question:
        "I'm cited inconsistently — sometimes yes, sometimes no, for the same query. Is that normal?",
      answer: [
    ...
    },
    {
      ...
      answer: [
        'Not necessarily — the AI-surface reporting was still in limited rollout as of mid-2026 and may simply not have reached your property yet (',
        {
          text: '9to5Google',
          href: 'https://9to5google.com/2026/06/02/google-ai-mode-overviews-opt-out/',
          external: true,
    ...
    {
      question:
        'Should a small business start with a free tool or go straight to a paid platform?',
      answer: [
    ...
    {
      question:
        'Are open-source tools like Canonry and Elmo a safe long-term bet for a business?',
      answer: [
