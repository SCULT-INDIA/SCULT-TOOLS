...
export const meta: BlogPost = {
  ...
  description:
    "A practical guide to verifying AI crawler access using robots.txt checks, server logs, and dedicated checker tools — plus why robots.txt alone isn't enough.",
  ...
  sections: [
    {
      ...
      body: [
        [
          { text: 'Layer 1: robots.txt.', bold: true },
          " Start by reading your site's `/robots.txt` file directly and checking, line by line, which AI-related user agents are explicitly allowed or disallowed. Free checker tools like the one from Mrs. Digital and LLM Pulse's robots.txt checker automate exactly this — parsing the file and reporting each bot's status against your declared rules (",
          {
            text: 'Mrs. Digital',
            href: 'https://mrs.digital/tools/ai-crawler-access-checker/',
            external: true,
          },
          '; ',
          {
            text: 'LLM Pulse',
            href: 'https://llmpulse.ai/robots-txt-checker',
            external: true,
          },
          ').',
        ],
        [
          { text: 'Layer 2: server logs.', bold: true },
          " Robots.txt only tells you what you've declared; your server logs tell you what actually happened. Search your access logs for AI bot user-agent strings — GPTBot, ClaudeBot, PerplexityBot, OAI-SearchBot — and check the HTTP status code returned for each hit. A 200 means the request succeeded; a 403 or 404 means it was blocked or the page wasn't found, even if robots.txt technically allows the bot (",
          {
            text: 'LLM Pulse',
            href: 'https://llmpulse.ai/blog/website-ai-bot-access/',
            external: true,
          },
          ').',
        ],
        [
          { text: 'Layer 3: live simulated requests.', bold: true },
          ' The most thorough check goes beyond static file parsing entirely. Some dedicated tools send requests that mimic the actual crawlers (matching their user-agent strings and request patterns) and analyze the live response your server returns — which catches CDN- or WAF-level blocks that a robots.txt read alone would never reveal, because those tools happen at a different layer of your infrastructure than the file that declares your intent (',
          {
            text: 'Siftly',
            href: 'https://siftly.ai/free-tools/crawler-audit',
            external: true,
          },
          ').',
        ],
        [
          'For a quick manual sanity check specifically on the ChatGPT question, you can also just ask ChatGPT (with web browsing/search enabled) to describe or summarize a specific page on your site and see whether it can actually retrieve current content, rather than falling back on stale training knowledge (',
          {
            text: 'Scorecraft',
            href: 'https://scorecraft.ai/blog/how-to-check-if-chatgpt-can-see-your-website',
            external: true,
          },
          ').',
        ],
    ...
    },
    {
      ...
      body: [
        ...
        [
          { text: 'Training crawlers', bold: true },
          ' — collect content to train future models, generally not tied to live citation in any specific answer:',
        ],
        [
          '– ',
          { text: 'GPTBot', bold: true },
          ' (OpenAI)',
          ' ',
          '– ',
          { text: 'ClaudeBot', bold: true },
          ' (Anthropic)',
          ' ',
          '– ',
          { text: 'Google-Extended', bold: true },
          ' (Google — a control token, not a distinct crawler; see below)',
        ],
        [
          '– ',
          { text: 'CCBot', bold: true },
          ' (Common Crawl, used by many downstream AI labs)',
        ],
        [
          { text: 'Search/retrieval crawlers', bold: true },
          " — fetch content specifically to answer live user queries with citations, meaning blocking these directly affects your eligibility to be cited in that engine's answers:",
        ],
        [
          '– ',
          { text: 'OAI-SearchBot', bold: true },
          ' and ',
          { text: 'ChatGPT-User', bold: true },
          ' (OpenAI)',
          ' ',
          '– ',
          { text: 'Claude-SearchBot', bold: true },
          ' and ',
          { text: 'Claude-User', bold: true },
          ' (Anthropic)',
        ],
        [
          '– ',
          { text: 'PerplexityBot', bold: true },
          ' (Perplexity)',
          ' ',
          'The distinction matters enormously for strategy: a site can reasonably choose to block the training-only crawlers (to keep content out of future model training data) while explicitly allowing the search/retrieval crawlers (to remain eligible for citation in live AI answers) — these are not the same decision, even though both categories technically fall under "AI bots" (',
          {
            text: 'No Hacks',
            href: 'https://nohacks.co/blog/ai-user-agents-landscape-2026',
            external: true,
          },
          '; ',
          {
            text: 'DataImpulse',
            href: 'https://dataimpulse.com/blog/robots-txt-ai-crawlers/',
            external: true,
          },
          ').',
        ],
        [
          "Blocking OAI-SearchBot, Claude-SearchBot, or PerplexityBot specifically removes your eligibility for citation in those platforms' live answer surfaces — a separate consequence from blocking GPTBot or ClaudeBot, which only affects future training data (",
          {
            text: 'OpenAI',
    ...
    },
    {
      ...
      body: [
        ...
        [
          '1. ',
          {
            text: 'A mismatch where robots.txt allows a bot but your CDN/WAF blocks it anyway.',
            bold: true,
          },
          " A 2026 analysis of robots.txt configurations across Cloudflare's network found this kind of mismatch to be a documented, common occurrence — bot-fight-mode settings or generic WAF rules can silently block crawlers that the site's own robots.txt technically permits (",
          {
            text: 'TechnologyChecker.io',
        ...
        [
          '2. ',
          { text: 'Undeclared, non-compliant crawling.', bold: true },
          " Cloudflare published evidence in 2025 that Perplexity specifically was using undeclared crawlers that rotated user-agents, IPs, and ASNs specifically to evade robots.txt-based blocking — meaning even a correctly configured robots.txt disallow doesn't guarantee that specific vendor actually stays away (",
          {
            text: 'reported via multiple 2026 AI-crawler guides',
            href: 'https://dataimpulse.com/blog/robots-txt-ai-crawlers/',
            external: true,
          },
          ').',
    ...
    },
    {
      ...
      body: [
        ...
        [
          '– OpenAI publishes official IP ranges and documents that changes to your robots.txt take about ',
          { text: '24 hours', bold: true },
          ' to propagate and be honored by OAI-SearchBot (',
          {
            text: 'OpenAI',
            href: 'https://developers.openai.com/api/docs/bots',
            external: true,
        ...
        [
          "– Anthropic similarly publishes official IP ranges for ClaudeBot, with the explicit caveat that blocking guarantees are limited to genuine requests from those ranges — a spoofed user-agent from a different IP isn't something robots.txt can stop (",
          {
            text: 'Anthropic support',
        ...
        [
          "If GPTBot shows up in your logs despite a disallow rule, the most likely explanations, in rough order of likelihood, are: the 24-hour propagation delay hasn't elapsed yet, a spoofed user agent from an unrelated IP, or a mismatch between your robots.txt and your CDN/WAF configuration (",
          {
            text: 'OpenAI',
            href: 'https://developers.openai.com/api/docs/bots',
            external: true,
        ...
        [
          'Google-Extended deserves a specific callout here: unlike the other bots on this list, it has ',
          { text: 'no separate crawling user-agent string of its own', bold: true },
          " — it's purely a robots.txt control token layered on top of Google's existing crawler infrastructure (the same infrastructure Googlebot uses). That means you cannot verify Google-Extended activity by searching logs for a distinct \"Google-Extended\" user agent the way you can for GPTBot or ClaudeBot; there's nothing distinct to search for (",
          {
            text: 'PushLeads',
            href: 'https://pushleads.com/google-extended-crawler/',
            external: true,
          },
          ').',
        ],
    ...
    },
    {
      ...
      body: [
        [
          ...
          " A site owner disallows GPTBot in robots.txt but continues seeing what looks like GPTBot activity in their logs. Following OpenAI's and the broader industry guidance above, the correct diagnostic sequence is: (1) confirm the robots.txt change is more than 24 hours old, (2) cross-check the requesting IPs against OpenAI's published GPTBot IP ranges rather than trusting the user-agent string, (3) if the IPs don't match, treat it as a spoofed or unrelated bot rather than an OpenAI compliance failure (",
          {
            text: 'OpenAI',
            href: 'https://developers.openai.com/api/docs/bots',
            external: true,
    ...
    },
    {
      ...
      body: [
        [
          "– OAI-SearchBot robots.txt changes take approximately 24 hours to propagate, per OpenAI's own documentation (",
          {
            text: 'OpenAI',
            href: 'https://developers.openai.com/api/docs/bots',
            external: true,
        ...
        [
          '– Anthropic recommends verifying ClaudeBot authenticity via published IP ranges rather than user-agent string alone, and notes blocking guarantees apply only to genuine requests from those ranges (',
          {
            text: 'Anthropic support',
            href: 'https://support.claude.com/en/articles/8896518',
            external: true,
        ...
        [
          "– Google-Extended has no distinct crawler user agent of its own — it is a robots.txt control token on Google's existing crawling infrastructure (",
          {
            text: 'PushLeads',
            href: 'https://pushleads.com/google-extended-crawler/',
            external: true,
        ...
        [
          "– A 2026 analysis of robots.txt across Cloudflare's network documented real-world mismatches between declared robots.txt rules and actual CDN/WAF-level blocking of AI crawlers (",
          {
            text: 'TechnologyChecker.io',
            href: 'https://technologychecker.io/blog/robots-txt-ai-crawlers-blocking-report',
            external: true,
        ...
        [
          '– Cloudflare reported evidence (2025) that Perplexity used undeclared crawlers rotating user-agents, IPs, and ASNs specifically to evade robots.txt blocking (',
          {
            text: 'reported via DataImpulse and other 2026 AI-crawler guides',
            href: 'https://dataimpulse.com/blog/robots-txt-ai-crawlers/',
            external: true,
          },
          ').',
    ...
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Publishers debating AI training opt-out', bold: true },
          ' commonly want GPTBot and ClaudeBot blocked while keeping OAI-SearchBot, ChatGPT-User, Claude-SearchBot, Claude-User, and PerplexityBot allowed — the nuanced four-plus-line configuration described above, rather than an all-or-nothing block.',
        ],
        [
          '– ',
          { text: 'E-commerce and SaaS marketing teams', bold: true },
          ' trying to diagnose "why doesn\'t ChatGPT know about our product" often discover, via log analysis, that a WAF rule was silently blocking the relevant search bots despite a permissive robots.txt — exactly the mismatch pattern documented by the Cloudflare-network analysis.',
        ],
        [
          '– ',
          { text: 'Agencies running technical AI-visibility audits', bold: true },
          ' for clients increasingly include a live-request-simulating crawler check as a standard deliverable, specifically because a robots.txt-only audit would miss real-world blocking that only shows up at the CDN layer.',
        ],
      ],
    },
    {
      ...
      body: [
        [
          '– ',
          { text: 'Reading robots.txt and stopping there.', bold: true },
          " It only shows declared intent, not what's actually happening at the CDN/WAF layer (",
          {
            text: 'Siftly',
            href: 'https://siftly.ai/free-tools/crawler-audit',
            external: true,
        ...
        [
          '– ',
          {
            text: 'Trusting a user-agent string in logs without IP verification.',
            bold: true,
          },
          ' User agents are trivially spoofable; only an IP-range cross-check confirms a genuine bot visit.',
        ],
        [
          '– ',
          { text: 'Blocking all "AI bots" indiscriminately.', bold: true },
          ' This conflates training crawlers with search/retrieval crawlers, potentially removing citation eligibility you actually wanted to keep.',
        ],
        [
          '– ',
          {
            text: 'Assuming Google-Extended activity is visible via a distinct user-agent search.',
            bold: true,
          },
          " It isn't — Google-Extended has no separate crawler string of its own.",
        ],
        [
          '– ',
          { text: 'Expecting instant robots.txt propagation.', bold: true },
          " OpenAI's documented 24-hour delay means a change you made an hour ago won't yet be reflected in OAI-SearchBot's behavior.",
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        [
          'Run a first check on your own domain with the ',
          { text: 'AI Visibility Checker', href: '/geo/ai-visibility-checker' },
          " to see whether AI engines can currently find and cite your content, then work through the robots.txt and server-log layers described in this article to confirm there isn't a CDN-level block hiding behind an otherwise-correct configuration.",
        ],
        [
          "If your site sits behind a CDN or WAF with bot-management rules you're not fully confident about, or you need a proper technical audit across robots.txt, server configuration, and content structure together, that's the kind of cross-layer diagnostic work scult.in's ",
          {
  ...
  faq: [
    {
      ...
      answer: [
        'Read your robots.txt for a GPTBot rule, check server logs for GPTBot requests returning HTTP 200, or use a dedicated AI crawler access checker tool (',
        {
          text: 'Mrs. Digital',
          href: 'https://mrs.digital/tools/ai-crawler-access-checker/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'It depends on whether OAI-SearchBot or ChatGPT-User can reach your pages per your robots.txt and any CDN-level blocks — checker tools test this directly (',
        {
          text: 'Scorecraft',
          href: 'https://scorecraft.ai/blog/how-to-check-if-chatgpt-can-see-your-website',
          external: true,
    ...
    },
    {
      ...
      answer: [
        "A robots.txt control token (not a distinct crawler) that lets site owners opt certain content out of use for training Google's generative AI models, layered on Google's existing crawling infrastructure (",
        {
          text: 'PushLeads',
          href: 'https://pushleads.com/google-extended-crawler/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        "OpenAI's crawler specifically for ChatGPT's web-search feature, distinct from the training-focused GPTBot (",
        {
          text: 'OpenAI',
          href: 'https://developers.openai.com/api/docs/bots',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Free tools that parse robots.txt are reliable for that specific layer; some go further and simulate live requests for a more complete picture (',
        {
          text: 'Siftly',
          href: 'https://siftly.ai/free-tools/crawler-audit',
          external: true,
    ...
    {
      question:
        'What should I look for in server logs to confirm an AI bot successfully crawled my site?',
      answer: [
        "The bot's user-agent string paired with an HTTP 200 response code on the relevant pages, not a 403 or 404 (",
        {
          text: 'LLM Pulse',
          href: 'https://llmpulse.ai/blog/website-ai-bot-access/',
          external: true,
    ...
    {
      question:
        'Do free AI crawler checker tools just parse robots.txt, or do they simulate a real crawl?',
      answer: [
        'Some go further than syntax parsing and send requests mimicking the actual crawlers to analyze the live response, catching CDN/WAF-level blocks (',
        {
          text: 'Siftly',
          href: 'https://siftly.ai/free-tools/crawler-audit',
          external: true,
    ...
    {
      question:
        'Can I verify Google-Extended access by checking logs for its user agent?',
      answer: [
        "No — it has no separate crawling user-agent string; it's purely a robots.txt control token on Google's existing infrastructure (",
        {
          text: 'PushLeads',
          href: 'https://pushleads.com/google-extended-crawler/',
          external: true,
    ...
    },
    {
      ...
      answer: [
        "About 24 hours, per OpenAI's own documentation (",
        {
          text: 'OpenAI',
          href: 'https://developers.openai.com/api/docs/bots',
          external: true,
    ...
    {
      question:
        'Why would GPTBot show up in my logs even though robots.txt disallows it?',
      answer: [
        'Possible causes: a spoofed user agent (verify against official IP ranges), a mismatch between robots.txt and CDN/WAF settings, or the 24-hour propagation delay not yet having elapsed (',
        {
          text: 'TechnologyChecker.io',
          href: 'https://technologychecker.io/blog/robots-txt-ai-crawlers-blocking-report',
          external: true,
    ...
    },
    {
      ...
      answer: [
        "Cross-check the requester's IP address against Anthropic's officially published IP range list rather than trusting the user-agent header alone (",
        {
          text: 'Anthropic support',
          href: 'https://support.claude.com/en/articles/8896518',
          external: true,
    ...
    {
      question:
        'Does robots.txt alone tell me whether AI crawlers can really reach my site?',
      answer: [
        'No — actual reachability also depends on CDN/WAF bot-management settings, which is why dedicated checkers test live requests rather than only parsing the file (',
        {
          text: 'Siftly',
          href: 'https://siftly.ai/free-tools/crawler-audit',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Typically, it reads your robots.txt line by line and shows which AI/search crawlers are allowed or blocked, sometimes alongside a simulated live fetch (',
        {
          text: 'Mrs. Digital',
          href: 'https://mrs.digital/tools/ai-crawler-access-checker/',
          external: true,
    ...
    {
      question:
        'Can my site be blocking AI crawlers at the CDN/WAF level even though robots.txt allows them?',
      answer: [
        'Yes — this mismatch is documented as common in a 2026 analysis of Cloudflare-network robots.txt configurations (',
        {
          text: 'TechnologyChecker.io',
          href: 'https://technologychecker.io/blog/robots-txt-ai-crawlers-blocking-report',
          external: true,
    ...
    {
      question:
        'How do I set up robots.txt to allow citation bots but block training bots?',
      answer: [
    ...
    },
    {
      ...
      answer: [
        'OpenAI publishes them in its official crawler documentation, which is the authoritative source to cross-check against rather than relying on user-agent strings alone (',
        {
          text: 'OpenAI',
          href: 'https://developers.openai.com/api/docs/bots',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'Anthropic publishes them via its support documentation for site owners wanting to verify or block ClaudeBot (',
        {
          text: 'Anthropic support',
          href: 'https://support.claude.com/en/articles/8896518',
          external: true,
    ...
    },
    {
      ...
      answer: [
        'No — while major labs generally state they honor robots.txt, Cloudflare reported evidence of undeclared, non-compliant crawling behavior specifically associated with Perplexity in 2025 (',
        {
          text: 'via DataImpulse',
          href: 'https://dataimpulse.com/blog/robots-txt-ai-crawlers/',
          external: true,
        },
        ').',
    ...
    {
      question:
        'Is there a difference between blocking a bot for training versus blocking it for search/retrieval?',
      answer: [
    ...
    {
      question:
        "Can a spoofed AI bot request bypass my defenses even if I've configured robots.txt correctly?",
      answer: [
    ...
    {
      question:
        'Does using Cloudflare or another CDN change how I should check for AI crawler access?',
      answer: [
    ...
    {
      question:
        'Are there emerging AI bots beyond the ones named in this article I should watch for?',
      answer: [
    ...
    {
      question:
        'Checking robots.txt manually vs using an automated AI crawler audit tool — which is better?',
      answer: [
    ...
    {
      question:
        'Server log analysis vs using a checker tool — which gives more confidence?',
      answer: [
    ...
    {
      question:
        "My site isn't appearing in ChatGPT search results — is crawler access the problem?",
      answer: [
    ...
    {
      question:
        'My CDN or WAF might be accidentally blocking AI crawlers — how do I confirm this?',
      answer: [
    ...
    {
      question:
        'AI crawlers are hitting my site more than expected — should I be worried?',
      answer: [
    ...
    {
      question:
        "My robots.txt looks correct but I still don't think I'm cited by AI engines — what else could it be?",
      answer: [
    ...
    {
      question:
        'Is there a free tool to check AI crawler access to my website right now?',
      answer: [
    ...
    {
      question:
        'Should I hire someone to configure my robots.txt and CDN settings for AI crawlers correctly?',
      answer: [
    ...
    {
      question:
        'Is it worth a full technical SEO audit specifically focused on AI crawler access?',
      answer: [
    ...
    {
      question:
        "What's the risk of getting this wrong and blocking AI crawlers unintentionally?",
      answer: [
