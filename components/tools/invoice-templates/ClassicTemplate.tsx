...
/**
 * The original, and still the default. General-purpose business invoice —
 * monochrome, hairline rules, small-caps labels. Colour is deliberately absent:
 * it costs the recipient ink on an office printer and renders unpredictably,
 * so structure comes entirely from weight and spacing. This is the template to
 * reach for when in doubt, which is why it is what a fresh invoice opens on.
 */
