# Verification Report — Article 020

**Article:** Why Wikipedia and Reddit Dominate AI Citations (And What It Means for Small Sites) (C103)
**Reviewer:** Content Engine (direct verification pass — see note below on methodology)
**Date:** 2026-08-21

**Sources checked:** 7 sources from the research brief; 9 sources cited in the final article; not independently re-fetched during this pass beyond the mechanical link/structure checks applied to all 100.
